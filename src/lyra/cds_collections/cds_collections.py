...
class Collection_sis_energy_derived_projections(Collection):
    ...
    @Collection.wrapper
    def download(cls, energy_product_type: OneOrMore[str], spatial_aggregation: str, temporal_aggregation: str, ensemble_member: OneOrMore[str], gcm: OneOrMore[str], rcm: str, experiment: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_energy_derived_projections.__download__(
            variable=variable, experiment=experiment, rcm=rcm, gcm=gcm, ensemble_member=ensemble_member, temporal_aggregation=temporal_aggregation, spatial_aggregation=spatial_aggregation, energy_product_type=energy_product_type
        )
    
    @classmethod
    def __download__(cls, energy_product_type: OneOrMore[str], spatial_aggregation: str, temporal_aggregation: str, ensemble_member: OneOrMore[str], gcm: OneOrMore[str], rcm: str, experiment: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(energy_product_type=energy_product_type, spatial_aggregation=spatial_aggregation, temporal_aggregation=temporal_aggregation, ensemble_member=ensemble_member, gcm=gcm, rcm=rcm, experiment=experiment, variable=variable)

class Collection_satellite_lake_water_level(Collection):

    @Collection.wrapper
    def download(cls, region: OneOrMore[str], lake: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_lake_water_level.__download__(
            variable=variable, lake=lake, region=region
        )
...
class Collection_satellite_lake_water_temperature(Collection):
    ...
    @Collection.wrapper
    def download(cls, version: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_lake_water_temperature.__download__(
            day=day, variable=variable, year=year, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, version: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(version=version, month=month, year=year, day=day, variable=variable)

class Collection_multi_origin_c3s_atlas(Collection):

    @Collection.wrapper
    def download(cls, domain: str, origin: str, experiment: str, variable: str, period: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_multi_origin_c3s_atlas.__download__(
            period=period, variable=variable, experiment=experiment, origin=origin, area_group=area_group, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: str, origin: str, experiment: str, variable: str, period: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(domain=domain, origin=origin, experiment=experiment, variable=variable, period=period, area_group=area_group)

class Collection_seasonal_postprocessed_single_levels(Collection):

    @Collection.wrapper
    def download(cls, originating_centre: str, month: OneOrMore[str], system: str, product_type: OneOrMore[str], leadtime_month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        return Collection_seasonal_postprocessed_single_levels.__download__(
            leadtime_month=leadtime_month, year=year, variable=variable, product_type=product_type, data_format=data_format, system=system, area_group=area_group, month=month, originating_centre=originating_centre
        )
    
    @classmethod
    def __download__(cls, originating_centre: str, month: OneOrMore[str], system: str, product_type: OneOrMore[str], leadtime_month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        ...
        return download_data(originating_centre=originating_centre, month=month, system=system, product_type=product_type, leadtime_month=leadtime_month, year=year, variable=variable, area_group=area_group, data_format=data_format)

class Collection_satellite_ice_sheet_mass_balance(Collection):

    @Collection.wrapper
    def download(cls, variable: str = 'all'):
        return Collection_satellite_ice_sheet_mass_balance.__download__(
            variable=variable
        )
...
class Collection_satellite_soil_moisture(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], version: OneOrMore[str], month: OneOrMore[str], type_of_sensor: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], type_of_record: OneOrMore[str], day: OneOrMore[str]):
        return Collection_satellite_soil_moisture.__download__(
            day=day, type_of_record=type_of_record, variable=variable, year=year, type_of_sensor=type_of_sensor, month=month, version=version, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], version: OneOrMore[str], month: OneOrMore[str], type_of_sensor: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], type_of_record: OneOrMore[str], day: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, version=version, month=month, type_of_sensor=type_of_sensor, year=year, variable=variable, type_of_record=type_of_record, day=day)
...
class Collection_insitu_gridded_observations_alpine_precipitation(Collection):
    ...
    def download(cls, dataset_issue: OneOrMore[str], variable: str = 'precipitation', version: OneOrMore[str] = '1.2'):
        return Collection_insitu_gridded_observations_alpine_precipitation.__download__(
            dataset_issue=dataset_issue, version=version, variable=variable
        )
...
class Collection_reanalysis_cerra_model_levels(Collection):
    ...
    @Collection.wrapper
    def download(cls, month: OneOrMore[str], data_type: OneOrMore[str], model_level: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_model_levels.__download__(
            day=day, time=time, variable=variable, year=year, model_level=model_level, data_format=data_format, data_type=data_type, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], data_type: OneOrMore[str], model_level: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, data_type=data_type, model_level=model_level, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_reanalysis_uerra_europe_single_levels(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], origin: str, year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_single_levels.__download__(
            day=day, time=time, variable=variable, year=year, data_format=data_format, origin=origin, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], origin: str, year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, origin=origin, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_insitu_observations_near_surface_temperature_us_climate_reference_network(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_near_surface_temperature_us_climate_reference_network.__download__(
            format=format, day=day, variable=variable, year=year, area_group=area_group, month=month, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(time_aggregation=time_aggregation, month=month, year=year, variable=variable, day=day, format=format, area_group=area_group)

class Collection_seasonal_original_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, originating_centre: str, pressure_level: OneOrMore[str], system: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        return Collection_seasonal_original_pressure_levels.__download__(
            day=day, variable=variable, year=year, data_format=data_format, leadtime_hour=leadtime_hour, month=month, system=system, area_group=area_group, pressure_level=pressure_level, originating_centre=originating_centre
        )
    
    @classmethod
    def __download__(cls, originating_centre: str, pressure_level: OneOrMore[str], system: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        originating_centre_valid_values = ['ecmwf', 'ukmo', 'meteo_france', 'dwd', 'cmcc', 'ncep', 'jma', 'eccc']
        assert originating_centre in originating_centre_valid_values
        ...
        return download_data(originating_centre=originating_centre, pressure_level=pressure_level, system=system, month=month, leadtime_hour=leadtime_hour, year=year, variable=variable, day=day, area_group=area_group, data_format=data_format)

class Collection_satellite_albedo(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], horizontal_resolution: OneOrMore[str], product_version: OneOrMore[str], satellite: OneOrMore[str], sensor: str, nominal_day: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Optional[Union[GeographicExtentMapType, LabelType]] = None, area: Optional[str] = None):
        return Collection_satellite_albedo.__download__(
            variable=variable, year=year, area=area, nominal_day=nominal_day, sensor=sensor, satellite=satellite, product_version=product_version, horizontal_resolution=horizontal_resolution, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], horizontal_resolution: OneOrMore[str], product_version: OneOrMore[str], satellite: OneOrMore[str], sensor: str, nominal_day: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Optional[Union[GeographicExtentMapType, LabelType]] = None, area: Optional[str] = None):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, horizontal_resolution=horizontal_resolution, product_version=product_version, satellite=satellite, sensor=sensor, nominal_day=nominal_day, year=year, variable=variable, area_group=area_group, area=area)

class Collection_satellite_upper_troposphere_humidity(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], sensor_on_satellite: str, year: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        return Collection_satellite_upper_troposphere_humidity.__download__(
            day=day, variable=variable, year=year, sensor_on_satellite=sensor_on_satellite, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], sensor_on_satellite: str, year: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, sensor_on_satellite=sensor_on_satellite, year=year, day=day, area_group=area_group, variable=variable)

class Collection_projections_cordex_domains_single_levels(Collection):

    @Collection.wrapper
    def download(cls, domain: str, gcm_model: str, temporal_resolution: str, horizontal_resolution: str, start_year: OneOrMore[str], rcm_model: str, end_year: OneOrMore[str], ensemble_member: str, experiment: str, variable: OneOrMore[str]):
        return Collection_projections_cordex_domains_single_levels.__download__(
            variable=variable, experiment=experiment, ensemble_member=ensemble_member, end_year=end_year, rcm_model=rcm_model, start_year=start_year, horizontal_resolution=horizontal_resolution, temporal_resolution=temporal_resolution, gcm_model=gcm_model, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: str, gcm_model: str, temporal_resolution: str, horizontal_resolution: str, start_year: OneOrMore[str], rcm_model: str, end_year: OneOrMore[str], ensemble_member: str, experiment: str, variable: OneOrMore[str]):
        ...
        return download_data(domain=domain, gcm_model=gcm_model, temporal_resolution=temporal_resolution, horizontal_resolution=horizontal_resolution, start_year=start_year, rcm_model=rcm_model, end_year=end_year, ensemble_member=ensemble_member, experiment=experiment, variable=variable)

class Collection_sis_health_vector(Collection):

    @Collection.wrapper
    def download(cls, experiment: OneOrMore[str], variable: OneOrMore[str], ensemble_statistic: OneOrMore[str]):
        return Collection_sis_health_vector.__download__(
            ensemble_statistic=ensemble_statistic, variable=variable, experiment=experiment
        )
    
    @classmethod
    def __download__(cls, experiment: OneOrMore[str], variable: OneOrMore[str], ensemble_statistic: OneOrMore[str]):
        ...
        return download_data(experiment=experiment, variable=variable, ensemble_statistic=ensemble_statistic)

class Collection_reanalysis_cerra_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, pressure_level: OneOrMore[str], month: OneOrMore[str], data_type: OneOrMore[str], leadtime_hour: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_pressure_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, leadtime_hour=leadtime_hour, data_type=data_type, month=month, pressure_level=pressure_level
        )
    
    @classmethod
    def __download__(cls, pressure_level: OneOrMore[str], month: OneOrMore[str], data_type: OneOrMore[str], leadtime_hour: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        ...
        return download_data(pressure_level=pressure_level, month=month, data_type=data_type, leadtime_hour=leadtime_hour, product_type=product_type, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_sis_marine_properties(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, month: OneOrMore[str], vertical_resolution: str, origin: str, experiment: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_marine_properties.__download__(
            variable=variable, year=year, experiment=experiment, origin=origin, vertical_resolution=vertical_resolution, month=month, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, month: OneOrMore[str], vertical_resolution: str, origin: str, experiment: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, month=month, vertical_resolution=vertical_resolution, origin=origin, experiment=experiment, year=year, variable=variable)

class Collection_reanalysis_uerra_europe_soil_levels(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], origin: str, soil_level: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_soil_levels.__download__(
            day=day, time=time, variable=variable, year=year, data_format=data_format, soil_level=soil_level, origin=origin, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], origin: str, soil_level: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, origin=origin, soil_level=soil_level, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_sis_biodiversity_era5_regional(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], derived_variable: OneOrMore[str], origin: str, region: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_era5_regional.__download__(
            variable=variable, region=region, origin=origin, derived_variable=derived_variable, version=version, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], derived_variable: OneOrMore[str], origin: str, region: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        ...
        return download_data(statistic=statistic, derived_variable=derived_variable, origin=origin, region=region, variable=variable, version=version)

class Collection_sis_hydrology_variables_derived_seasonal_reforecast(Collection):

    @Collection.wrapper
    def download(cls, version: OneOrMore[str], month: OneOrMore[str], hydrological_model: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_hydrology_variables_derived_seasonal_reforecast.__download__(
            variable=variable, year=year, hydrological_model=hydrological_model, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, version: OneOrMore[str], month: OneOrMore[str], hydrological_model: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(version=version, month=month, hydrological_model=hydrological_model, year=year, variable=variable)

class Collection_reanalysis_era5_single_levels(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis'):
        return Collection_reanalysis_era5_single_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, download_format=download_format, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, year=year, variable=variable, time=time, day=day, area_group=area_group, download_format=download_format, data_format=data_format, product_type=product_type)

class Collection_sis_energy_derived_reanalysis(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], energy_product_type: OneOrMore[str], spatial_aggregation: OneOrMore[str], temporal_aggregation: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_energy_derived_reanalysis.__download__(
            variable=variable, year=year, temporal_aggregation=temporal_aggregation, spatial_aggregation=spatial_aggregation, energy_product_type=energy_product_type, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], energy_product_type: OneOrMore[str], spatial_aggregation: OneOrMore[str], temporal_aggregation: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, energy_product_type=energy_product_type, spatial_aggregation=spatial_aggregation, temporal_aggregation=temporal_aggregation, year=year, variable=variable)

class Collection_satellite_sea_level_global(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], version: str = 'vDT2021'):
        return Collection_satellite_sea_level_global.__download__(
            day=day, variable=variable, year=year, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], version: str = 'vDT2021'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, year=year, variable=variable, day=day, version=version)

class Collection_satellite_sea_surface_temperature_ensemble_product(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_sea_surface_temperature_ensemble_product.__download__(
            day=day, month=month, variable=variable, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(year=year, month=month, day=day, variable=variable)

class Collection_reanalysis_carra_height_levels(Collection):

    @Collection.wrapper
    def download(cls, domain: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], height_level: OneOrMore[str], product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_height_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, height_level=height_level, leadtime_hour=leadtime_hour, month=month, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], height_level: OneOrMore[str], product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        ...
        return download_data(domain=domain, month=month, leadtime_hour=leadtime_hour, height_level=height_level, product_type=product_type, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_derived_era5_land_daily_statistics(Collection):

    @Collection.wrapper
    def download(cls, month: str, year: str, variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', daily_statistic: str = 'daily_mean', frequency: str = '1_hourly', time_zone: str = 'utc+00:00'):
        return Collection_derived_era5_land_daily_statistics.__download__(
            time_zone=time_zone, day=day, variable=variable, year=year, frequency=frequency, daily_statistic=daily_statistic, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: str, year: str, variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', daily_statistic: str = 'daily_mean', frequency: str = '1_hourly', time_zone: str = 'utc+00:00'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, year=year, variable=variable, day=day, area_group=area_group, daily_statistic=daily_statistic, frequency=frequency, time_zone=time_zone)

class Collection_insitu_observations_woudc_ozone_total_column_and_profiles(Collection):

    @Collection.wrapper
    def download(cls, observation_type: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_woudc_ozone_total_column_and_profiles.__download__(
            format=format, day=day, variable=variable, year=year, area_group=area_group, month=month, observation_type=observation_type
        )
    
    @classmethod
    def __download__(cls, observation_type: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(observation_type=observation_type, month=month, year=year, variable=variable, day=day, format=format, area_group=area_group)

class Collection_insitu_glaciers_extent(Collection):

    @Collection.wrapper
    def download(cls, variable: OneOrMore[str], product_type: OneOrMore[str], version: str = '7'):
        return Collection_insitu_glaciers_extent.__download__(
            product_type=product_type, version=version, variable=variable
        )
    
    @classmethod
    def __download__(cls, variable: OneOrMore[str], product_type: OneOrMore[str], version: str = '7'):
        ...
        return download_data(variable=variable, product_type=product_type, version=version)

class Collection_projections_cmip5_daily_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, model: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str], ensemble_member: str = 'r1i1p1'):
        return Collection_projections_cmip5_daily_pressure_levels.__download__(
            period=period, variable=variable, experiment=experiment, ensemble_member=ensemble_member, model=model
        )
    
    @classmethod
    def __download__(cls, model: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str], ensemble_member: str = 'r1i1p1'):
        ...
        return download_data(model=model, experiment=experiment, variable=variable, period=period, ensemble_member=ensemble_member)

class Collection_satellite_fire_burned_area(Collection):

    @Collection.wrapper
    def download(cls, version: str, month: OneOrMore[str], sensor: str, origin: str, region: OneOrMore[str], nominal_day: OneOrMore[str], year: OneOrMore[str], variable: str):
        return Collection_satellite_fire_burned_area.__download__(
            variable=variable, year=year, nominal_day=nominal_day, region=region, origin=origin, sensor=sensor, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, version: str, month: OneOrMore[str], sensor: str, origin: str, region: OneOrMore[str], nominal_day: OneOrMore[str], year: OneOrMore[str], variable: str):
        ...
        return download_data(version=version, month=month, sensor=sensor, origin=origin, region=region, nominal_day=nominal_day, year=year, variable=variable)

class Collection_reanalysis_uerra_europe_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, pressure_level: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_pressure_levels.__download__(
            day=day, time=time, variable=variable, year=year, data_format=data_format, month=month, pressure_level=pressure_level
        )
    
    @classmethod
    def __download__(cls, pressure_level: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        ...
        return download_data(pressure_level=pressure_level, month=month, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_satellite_sea_ice_edge_type(Collection):

    @Collection.wrapper
    def download(cls, cdr_type: str, month: OneOrMore[str], region: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], version: str = '3_0'):
        return Collection_satellite_sea_ice_edge_type.__download__(
            day=day, variable=variable, year=year, region=region, month=month, version=version, cdr_type=cdr_type
        )
    
    @classmethod
    def __download__(cls, cdr_type: str, month: OneOrMore[str], region: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], version: str = '3_0'):
        ...
        return download_data(cdr_type=cdr_type, month=month, region=region, year=year, variable=variable, day=day, version=version)

class Collection_sis_ocean_wave_timeseries(Collection):

    @Collection.wrapper
    def download(cls, experiment: str, year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_ocean_wave_timeseries.__download__(
            variable=variable, year=year, experiment=experiment
        )
    
    @classmethod
    def __download__(cls, experiment: str, year: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(experiment=experiment, year=year, variable=variable)

class Collection_satellite_cloud_properties(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, climate_data_record_type: str, month: OneOrMore[str], sensor_on_satellite: OneOrMore[str], origin: str, product_family: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_cloud_properties.__download__(
            day=day, variable=variable, year=year, product_family=product_family, origin=origin, sensor_on_satellite=sensor_on_satellite, area_group=area_group, month=month, climate_data_record_type=climate_data_record_type, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, climate_data_record_type: str, month: OneOrMore[str], sensor_on_satellite: OneOrMore[str], origin: str, product_family: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(time_aggregation=time_aggregation, climate_data_record_type=climate_data_record_type, month=month, sensor_on_satellite=sensor_on_satellite, origin=origin, product_family=product_family, year=year, variable=variable, day=day, area_group=area_group)

class Collection_seasonal_postprocessed_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, originating_centre: str, pressure_level: OneOrMore[str], system: str, month: OneOrMore[str], product_type: OneOrMore[str], leadtime_month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        return Collection_seasonal_postprocessed_pressure_levels.__download__(
            leadtime_month=leadtime_month, year=year, variable=variable, product_type=product_type, data_format=data_format, month=month, system=system, area_group=area_group, pressure_level=pressure_level, originating_centre=originating_centre
        )
    
    @classmethod
    def __download__(cls, originating_centre: str, pressure_level: OneOrMore[str], system: str, month: OneOrMore[str], product_type: OneOrMore[str], leadtime_month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        originating_centre_valid_values = ['ecmwf', 'ukmo', 'meteo_france', 'dwd', 'cmcc', 'ncep', 'jma', 'eccc']
        assert originating_centre in originating_centre_valid_values
        ...
        return download_data(originating_centre=originating_centre, pressure_level=pressure_level, system=system, month=month, product_type=product_type, leadtime_month=leadtime_month, year=year, variable=variable, area_group=area_group, data_format=data_format)

class Collection_sis_heat_and_cold_spells(Collection):

    @Collection.wrapper
    def download(cls, definition: str, experiment: OneOrMore[str], variable: OneOrMore[str], ensemble_statistic: OneOrMore[str]):
        return Collection_sis_heat_and_cold_spells.__download__(
            ensemble_statistic=ensemble_statistic, variable=variable, experiment=experiment, definition=definition
        )
    
    @classmethod
    def __download__(cls, definition: str, experiment: OneOrMore[str], variable: OneOrMore[str], ensemble_statistic: OneOrMore[str]):
        ...
        return download_data(definition=definition, experiment=experiment, variable=variable, ensemble_statistic=ensemble_statistic)
...
class Collection_derived_gridded_glacier_mass_change(Collection):
    ...
    def download(cls, hydrological_year: OneOrMore[str], product_version: str = 'wgms_fog_2023_09', variable: str = 'glacier_mass_change'):
        return Collection_derived_gridded_glacier_mass_change.__download__(
            hydrological_year=hydrological_year, variable=variable, product_version=product_version
        )
...
class Collection_reanalysis_cerra_land(Collection):
    ...
    @Collection.wrapper
    def download(cls, month: OneOrMore[str], leadtime_hour: OneOrMore[str], soil_layer: OneOrMore[str], level_type: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_land.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, level_type=level_type, soil_layer=soil_layer, leadtime_hour=leadtime_hour, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], leadtime_hour: OneOrMore[str], soil_layer: OneOrMore[str], level_type: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, leadtime_hour=leadtime_hour, soil_layer=soil_layer, level_type=level_type, product_type=product_type, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_satellite_sea_surface_temperature(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], sensor_on_satellite: str, processinglevel: str, year: OneOrMore[str], day: OneOrMore[str], version: str = '2_1', variable: str = 'all'):
        return Collection_satellite_sea_surface_temperature.__download__(
            day=day, variable=variable, year=year, processinglevel=processinglevel, sensor_on_satellite=sensor_on_satellite, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], sensor_on_satellite: str, processinglevel: str, year: OneOrMore[str], day: OneOrMore[str], version: str = '2_1', variable: str = 'all'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, sensor_on_satellite=sensor_on_satellite, processinglevel=processinglevel, year=year, day=day, version=version, variable=variable)

class Collection_reanalysis_uerra_europe_height_levels(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], height_level: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_height_levels.__download__(
            day=day, time=time, variable=variable, year=year, data_format=data_format, height_level=height_level, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], height_level: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, height_level=height_level, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_reanalysis_era5_land(Collection):

    @Collection.wrapper
    def download(cls, month: str, year: str, variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib'):
        return Collection_reanalysis_era5_land.__download__(
            day=day, time=time, variable=variable, year=year, data_format=data_format, download_format=download_format, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: str, year: str, variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, year=year, variable=variable, time=time, day=day, area_group=area_group, download_format=download_format, data_format=data_format)

class Collection_reanalysis_carra_single_levels(Collection):

    @Collection.wrapper
    def download(cls, domain: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], soil_level: OneOrMore[str], level_type: str, product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_single_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, level_type=level_type, soil_level=soil_level, leadtime_hour=leadtime_hour, month=month, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], soil_level: OneOrMore[str], level_type: str, product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        domain_valid_values = ['east_domain', 'west_domain']
        assert domain in domain_valid_values
        ...
        return download_data(domain=domain, month=month, leadtime_hour=leadtime_hour, soil_level=soil_level, level_type=level_type, product_type=product_type, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_sis_biodiversity_cmip5_regional(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], model: OneOrMore[str], derived_variable: OneOrMore[str], region: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_cmip5_regional.__download__(
            variable=variable, experiment=experiment, ensemble_member=ensemble_member, region=region, derived_variable=derived_variable, version=version, model=model, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], model: OneOrMore[str], derived_variable: OneOrMore[str], region: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        statistic_valid_values = ['mean', 'median', '25th_quartile', '75th_quartile']
        assert statistic in statistic_valid_values
        ...
        return download_data(statistic=statistic, model=model, derived_variable=derived_variable, region=region, ensemble_member=ensemble_member, experiment=experiment, variable=variable, version=version)

class Collection_insitu_gridded_observations_global_and_regional(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, version: OneOrMore[str], statistic: OneOrMore[str], origin: str, region: str, year: OneOrMore[str], variable: OneOrMore[str], horizontal_aggregation: OneOrMore[str]):
        return Collection_insitu_gridded_observations_global_and_regional.__download__(
            horizontal_aggregation=horizontal_aggregation, variable=variable, year=year, region=region, time_aggregation=time_aggregation, origin=origin, version=version, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, version: OneOrMore[str], statistic: OneOrMore[str], origin: str, region: str, year: OneOrMore[str], variable: OneOrMore[str], horizontal_aggregation: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, version=version, statistic=statistic, origin=origin, region=region, year=year, variable=variable, horizontal_aggregation=horizontal_aggregation)

class Collection_projections_cmip5_daily_single_levels(Collection):

    @Collection.wrapper
    def download(cls, model: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str], ensemble_member: str = 'r1i1p1'):
        return Collection_projections_cmip5_daily_single_levels.__download__(
            period=period, variable=variable, experiment=experiment, ensemble_member=ensemble_member, model=model
        )
...
class Collection_sis_biodiversity_era5_global(Collection):
    ...
    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], derived_variable: OneOrMore[str], temporal_aggregation: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_era5_global.__download__(
            variable=variable, temporal_aggregation=temporal_aggregation, derived_variable=derived_variable, version=version, statistic=statistic
        )
...
class Collection_reanalysis_era5_land_monthly_means(Collection):
    ...
    @Collection.wrapper
    def download(cls, month: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib'):
        return Collection_reanalysis_era5_land_monthly_means.__download__(
            time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, download_format=download_format, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, product_type=product_type, year=year, variable=variable, time=time, area_group=area_group, download_format=download_format, data_format=data_format)

class Collection_insitu_comprehensive_upper_air_observation_network(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_comprehensive_upper_air_observation_network.__download__(
            format=format, day=day, variable=variable, year=year, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, year=year, variable=variable, day=day, format=format, area_group=area_group)

class Collection_projections_cmip6(Collection):

    @Collection.wrapper
    def download(cls, model: str, temporal_resolution: str, month: OneOrMore[str], level: OneOrMore[str], experiment: str, year: OneOrMore[str], variable: str, day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_projections_cmip6.__download__(
            day=day, variable=variable, year=year, experiment=experiment, level=level, area_group=area_group, month=month, temporal_resolution=temporal_resolution, model=model
        )
    
    @classmethod
    def __download__(cls, model: str, temporal_resolution: str, month: OneOrMore[str], level: OneOrMore[str], experiment: str, year: OneOrMore[str], variable: str, day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(model=model, temporal_resolution=temporal_resolution, month=month, level=level, experiment=experiment, year=year, variable=variable, day=day, area_group=area_group)

class Collection_insitu_observations_gruan_reference_network(Collection):

    @Collection.wrapper
    def download(cls, month: str, year: str, variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_gruan_reference_network.__download__(
            format=format, day=day, variable=variable, year=year, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: str, year: str, variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
...
class Collection_insitu_gridded_observations_europe(Collection):
    ...
    @Collection.wrapper
    def download(cls, version: OneOrMore[str], product_type: str, variable: OneOrMore[str], grid_resolution: str, period: str):
        return Collection_insitu_gridded_observations_europe.__download__(
            period=period, grid_resolution=grid_resolution, variable=variable, product_type=product_type, version=version
        )
    
    @classmethod
    def __download__(cls, version: OneOrMore[str], product_type: str, variable: OneOrMore[str], grid_resolution: str, period: str):
        ...
        return download_data(version=version, product_type=product_type, variable=variable, grid_resolution=grid_resolution, period=period)

class Collection_derived_era5_pressure_levels_daily_statistics(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], pressure_level: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', frequency: str = '1_hourly', time_zone: str = 'utc+00:00'):
        return Collection_derived_era5_pressure_levels_daily_statistics.__download__(
            time_zone=time_zone, day=day, variable=variable, year=year, frequency=frequency, product_type=product_type, pressure_level=pressure_level, daily_statistic=daily_statistic, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], pressure_level: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', frequency: str = '1_hourly', time_zone: str = 'utc+00:00'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, pressure_level=pressure_level, year=year, variable=variable, day=day, area_group=area_group, daily_statistic=daily_statistic, product_type=product_type, frequency=frequency, time_zone=time_zone)

class Collection_reanalysis_era5_complete(Collection):

    @Collection.wrapper
    def download(cls, download_instructions: Optional[str] = None):
        return Collection_reanalysis_era5_complete.__download__(
...
class Collection_derived_near_surface_meteorological_variables(Collection):
    ...
    @Collection.wrapper
    def download(cls, reference_dataset: str, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '2.1'):
        return Collection_derived_near_surface_meteorological_variables.__download__(
            variable=variable, year=year, reference_dataset=reference_dataset, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, reference_dataset: str, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '2.1'):
        ...
        return download_data(reference_dataset=reference_dataset, month=month, year=year, variable=variable, version=version)

class Collection_sis_tourism_snow_indicators(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, version: OneOrMore[str], statistic: OneOrMore[str], gcm: OneOrMore[str], rcm: str, experiment: str, year: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_tourism_snow_indicators.__download__(
            period=period, variable=variable, year=year, experiment=experiment, rcm=rcm, gcm=gcm, time_aggregation=time_aggregation, version=version, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, version: OneOrMore[str], statistic: OneOrMore[str], gcm: OneOrMore[str], rcm: str, experiment: str, year: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, version=version, statistic=statistic, gcm=gcm, rcm=rcm, experiment=experiment, year=year, variable=variable, period=period)

class Collection_reanalysis_uerra_europe_complete(Collection):

    @Collection.wrapper
    def download(cls, download_instructions: Optional[str] = None):
        return Collection_reanalysis_uerra_europe_complete.__download__(
            download_instructions=download_instructions
        )
...
class Collection_sis_european_risk_extreme_precipitation_indicators(Collection):
    ...
    @Collection.wrapper
    def download(cls, percentile: OneOrMore[str], spatial_coverage: OneOrMore[str], return_period: OneOrMore[str], temporal_aggregation: OneOrMore[str], product_type: OneOrMore[str], city: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_european_risk_extreme_precipitation_indicators.__download__(
            period=period, variable=variable, city=city, product_type=product_type, temporal_aggregation=temporal_aggregation, return_period=return_period, spatial_coverage=spatial_coverage, percentile=percentile
        )
    
    @classmethod
    def __download__(cls, percentile: OneOrMore[str], spatial_coverage: OneOrMore[str], return_period: OneOrMore[str], temporal_aggregation: OneOrMore[str], product_type: OneOrMore[str], city: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        ...
        return download_data(percentile=percentile, spatial_coverage=spatial_coverage, return_period=return_period, temporal_aggregation=temporal_aggregation, product_type=product_type, city=city, variable=variable, period=period)

class Collection_satellite_total_column_water_vapour_land_ocean(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], product: str, temporal_aggregation: str, year: OneOrMore[str], horizontal_aggregation: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_total_column_water_vapour_land_ocean.__download__(
            day=day, horizontal_aggregation=horizontal_aggregation, variable=variable, year=year, temporal_aggregation=temporal_aggregation, product=product, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], product: str, temporal_aggregation: str, year: OneOrMore[str], horizontal_aggregation: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, product=product, temporal_aggregation=temporal_aggregation, year=year, horizontal_aggregation=horizontal_aggregation, day=day, variable=variable)

class Collection_sis_temperature_statistics(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], ensemble_statistic: OneOrMore[str], experiment: OneOrMore[str], variable: str, period: str):
        return Collection_sis_temperature_statistics.__download__(
            period=period, variable=variable, experiment=experiment, ensemble_statistic=ensemble_statistic, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], ensemble_statistic: OneOrMore[str], experiment: OneOrMore[str], variable: str, period: str):
        ...
        return download_data(statistic=statistic, ensemble_statistic=ensemble_statistic, experiment=experiment, variable=variable, period=period)

class Collection_satellite_fire_radiative_power(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, version: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], observation_time: OneOrMore[str], product_type: str, year: str, horizontal_aggregation: str, day: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_fire_radiative_power.__download__(
            day=day, horizontal_aggregation=horizontal_aggregation, variable=variable, year=year, product_type=product_type, observation_time=observation_time, satellite=satellite, month=month, version=version, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, version: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], observation_time: OneOrMore[str], product_type: str, year: str, horizontal_aggregation: str, day: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(time_aggregation=time_aggregation, version=version, month=month, satellite=satellite, observation_time=observation_time, product_type=product_type, year=year, horizontal_aggregation=horizontal_aggregation, day=day, variable=variable)

class Collection_satellite_methane(Collection):

    @Collection.wrapper
    def download(cls, version: OneOrMore[str], sensor_and_algorithm: str, month: OneOrMore[str], processing_level: OneOrMore[str], year: OneOrMore[str], variable: str, day: OneOrMore[str]):
        return Collection_satellite_methane.__download__(
            day=day, variable=variable, year=year, month=month, processing_level=processing_level, sensor_and_algorithm=sensor_and_algorithm, version=version
        )
    
    @classmethod
    def __download__(cls, version: OneOrMore[str], sensor_and_algorithm: str, month: OneOrMore[str], processing_level: OneOrMore[str], year: OneOrMore[str], variable: str, day: OneOrMore[str]):
        ...
        return download_data(version=version, sensor_and_algorithm=sensor_and_algorithm, month=month, processing_level=processing_level, year=year, variable=variable, day=day)

class Collection_satellite_ice_sheet_elevation_change(Collection):

    @Collection.wrapper
    def download(cls, domain: OneOrMore[str], version: OneOrMore[str], climate_data_record_type: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_ice_sheet_elevation_change.__download__(
            variable=variable, climate_data_record_type=climate_data_record_type, version=version, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: OneOrMore[str], version: OneOrMore[str], climate_data_record_type: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(domain=domain, version=version, climate_data_record_type=climate_data_record_type, variable=variable)

class Collection_seasonal_monthly_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, originating_centre: str, pressure_level: OneOrMore[str], system: str, month: OneOrMore[str], product_type: OneOrMore[str], leadtime_month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        return Collection_seasonal_monthly_pressure_levels.__download__(
            leadtime_month=leadtime_month, year=year, variable=variable, product_type=product_type, data_format=data_format, month=month, system=system, area_group=area_group, pressure_level=pressure_level, originating_centre=originating_centre
        )
...
class Collection_satellite_carbon_dioxide(Collection):
    ...
    @Collection.wrapper
    def download(cls, version: OneOrMore[str], sensor_and_algorithm: str, month: OneOrMore[str], processing_level: OneOrMore[str], year: OneOrMore[str], variable: str, day: OneOrMore[str]):
        return Collection_satellite_carbon_dioxide.__download__(
            day=day, variable=variable, year=year, month=month, processing_level=processing_level, sensor_and_algorithm=sensor_and_algorithm, version=version
        )
...
class Collection_insitu_observations_surface_land(Collection):
    ...
    @Collection.wrapper
    def download(cls, data_quality: OneOrMore[str], month: OneOrMore[str], usage_restrictions: OneOrMore[str], time_aggregation: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_surface_land.__download__(
            day=day, variable=variable, year=year, usage_restrictions=usage_restrictions, data_quality=data_quality, area_group=area_group, month=month, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, data_quality: OneOrMore[str], month: OneOrMore[str], usage_restrictions: OneOrMore[str], time_aggregation: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(data_quality=data_quality, month=month, usage_restrictions=usage_restrictions, time_aggregation=time_aggregation, year=year, variable=variable, day=day, area_group=area_group)

class Collection_projections_cmip5_monthly_single_levels(Collection):

    @Collection.wrapper
    def download(cls, model: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str], ensemble_member: str = 'r1i1p1'):
        return Collection_projections_cmip5_monthly_single_levels.__download__(
            period=period, variable=variable, experiment=experiment, ensemble_member=ensemble_member, model=model
        )
...
class Collection_insitu_observations_surface_marine(Collection):
    ...
    @Collection.wrapper
    def download(cls, data_quality: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_surface_marine.__download__(
            day=day, variable=variable, year=year, area_group=area_group, month=month, data_quality=data_quality
        )
    
    @classmethod
    def __download__(cls, data_quality: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        data_quality_valid_values = ['failed', 'passed']
        assert data_quality in data_quality_valid_values
        ...
        return download_data(data_quality=data_quality, month=month, year=year, variable=variable, day=day, area_group=area_group)

class Collection_seasonal_monthly_ocean(Collection):

    @Collection.wrapper
    def download(cls, originating_centre: str, month: OneOrMore[str], system: str, forecast_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_seasonal_monthly_ocean.__download__(
            variable=variable, year=year, forecast_type=forecast_type, system=system, month=month, originating_centre=originating_centre
        )
    
    @classmethod
    def __download__(cls, originating_centre: str, month: OneOrMore[str], system: str, forecast_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(originating_centre=originating_centre, month=month, system=system, forecast_type=forecast_type, year=year, variable=variable)

class Collection_seasonal_monthly_single_levels(Collection):

    @Collection.wrapper
    def download(cls, originating_centre: str, month: OneOrMore[str], system: str, product_type: OneOrMore[str], leadtime_month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        return Collection_seasonal_monthly_single_levels.__download__(
            leadtime_month=leadtime_month, year=year, variable=variable, product_type=product_type, data_format=data_format, system=system, area_group=area_group, month=month, originating_centre=originating_centre
        )
...
class Collection_satellite_greenland_ice_sheet_velocity(Collection):
    ...
    @Collection.wrapper
    def download(cls, version: OneOrMore[str], period: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_greenland_ice_sheet_velocity.__download__(
            variable=variable, period=period, version=version
        )
...
class Collection_satellite_ozone_v1(Collection):
    ...
    @Collection.wrapper
    def download(cls, version: OneOrMore[str], processing_level: str, month: OneOrMore[str], vertical_aggregation: str, sensor: OneOrMore[str], algorithm: str, year: OneOrMore[str], variable: str):
        return Collection_satellite_ozone_v1.__download__(
            variable=variable, year=year, algorithm=algorithm, sensor=sensor, month=month, vertical_aggregation=vertical_aggregation, processing_level=processing_level, version=version
        )
    
    @classmethod
    def __download__(cls, version: OneOrMore[str], processing_level: str, month: OneOrMore[str], vertical_aggregation: str, sensor: OneOrMore[str], algorithm: str, year: OneOrMore[str], variable: str):
        ...
        return download_data(version=version, processing_level=processing_level, month=month, vertical_aggregation=vertical_aggregation, sensor=sensor, algorithm=algorithm, year=year, variable=variable)

class Collection_derived_era5_single_levels_daily_statistics(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', frequency: str = '1_hourly', time_zone: str = 'utc+00:00'):
        return Collection_derived_era5_single_levels_daily_statistics.__download__(
            time_zone=time_zone, day=day, variable=variable, year=year, frequency=frequency, product_type=product_type, daily_statistic=daily_statistic, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', frequency: str = '1_hourly', time_zone: str = 'utc+00:00'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, year=year, variable=variable, day=day, area_group=area_group, daily_statistic=daily_statistic, product_type=product_type, frequency=frequency, time_zone=time_zone)

class Collection_seasonal_original_single_levels(Collection):

    @Collection.wrapper
    def download(cls, originating_centre: str, month: OneOrMore[str], system: str, leadtime_hour: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        return Collection_seasonal_original_single_levels.__download__(
            day=day, variable=variable, year=year, data_format=data_format, leadtime_hour=leadtime_hour, system=system, area_group=area_group, month=month, originating_centre=originating_centre
        )
    
    @classmethod
    def __download__(cls, originating_centre: str, month: OneOrMore[str], system: str, leadtime_hour: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
        originating_centre_valid_values = ['ecmwf', 'ukmo', 'meteo_france', 'dwd', 'cmcc', 'ncep', 'jma', 'eccc']
        assert originating_centre in originating_centre_valid_values
        ...
        return download_data(originating_centre=originating_centre, month=month, system=system, leadtime_hour=leadtime_hour, year=year, variable=variable, day=day, area_group=area_group, data_format=data_format)

class Collection_reanalysis_cerra_single_levels(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], data_type: OneOrMore[str], leadtime_hour: OneOrMore[str], soil_layer: OneOrMore[str], level_type: str, product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_single_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, level_type=level_type, soil_layer=soil_layer, leadtime_hour=leadtime_hour, data_type=data_type, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], data_type: OneOrMore[str], leadtime_hour: OneOrMore[str], soil_layer: OneOrMore[str], level_type: str, product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, data_type=data_type, leadtime_hour=leadtime_hour, soil_layer=soil_layer, level_type=level_type, product_type=product_type, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_satellite_precipitation_microwave(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, month: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str] = 'v1.0', variable: str = 'all'):
        return Collection_satellite_precipitation_microwave.__download__(
            day=day, variable=variable, year=year, month=month, version=version, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, month: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str] = 'v1.0', variable: str = 'all'):
        time_aggregation_valid_values = ['daily', 'monthly']
        assert time_aggregation in time_aggregation_valid_values
        ...
        return download_data(time_aggregation=time_aggregation, month=month, year=year, day=day, version=version, variable=variable)

class Collection_sis_ocean_wave_indicators(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], experiment: str, variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_ocean_wave_indicators.__download__(
            period=period, variable=variable, experiment=experiment, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], experiment: str, variable: OneOrMore[str], period: OneOrMore[str]):
        ...
        return download_data(statistic=statistic, experiment=experiment, variable=variable, period=period)

class Collection_sis_european_wind_storm_synthetic_events(Collection):

    @Collection.wrapper
    def download(cls, version_id: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], month: OneOrMore[str]):
        return Collection_sis_european_wind_storm_synthetic_events.__download__(
            month=month, variable=variable, year=year, version_id=version_id
        )
...
class Collection_reanalysis_era5_single_levels_monthly_means(Collection):
    ...
    @Collection.wrapper
    def download(cls, month: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib'):
        return Collection_reanalysis_era5_single_levels_monthly_means.__download__(
            time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, download_format=download_format, area_group=area_group, month=month
        )
...
class Collection_reanalysis_cerra_height_levels(Collection):
    ...
    @Collection.wrapper
    def download(cls, month: OneOrMore[str], data_type: OneOrMore[str], leadtime_hour: OneOrMore[str], height_level: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_height_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, height_level=height_level, leadtime_hour=leadtime_hour, data_type=data_type, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], data_type: OneOrMore[str], leadtime_hour: OneOrMore[str], height_level: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, data_type=data_type, leadtime_hour=leadtime_hour, height_level=height_level, product_type=product_type, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_sis_agroproductivity_indicators(Collection):

    @Collection.wrapper
    def download(cls, crop_type: OneOrMore[str], harvest_year: str, month: OneOrMore[str], growing_season: OneOrMore[str], product_family: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str]):
        return Collection_sis_agroproductivity_indicators.__download__(
            day=day, variable=variable, year=year, product_family=product_family, growing_season=growing_season, month=month, harvest_year=harvest_year, crop_type=crop_type
        )
    
    @classmethod
    def __download__(cls, crop_type: OneOrMore[str], harvest_year: str, month: OneOrMore[str], growing_season: OneOrMore[str], product_family: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str]):
        ...
        return download_data(crop_type=crop_type, harvest_year=harvest_year, month=month, growing_season=growing_season, product_family=product_family, year=year, variable=variable, day=day)

class Collection_derived_reanalysis_energy_moisture_budget(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], variable: str, month: OneOrMore[str], area_group: Optional[Union[LabelType, GeographicExtentMapType]] = None):
        return Collection_derived_reanalysis_energy_moisture_budget.__download__(
            area_group=area_group, month=month, variable=variable, year=year
        )
...
class Collection_sis_hydrology_variables_derived_projections(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: str, hydrological_model: OneOrMore[str], variable_type: str, ensemble_member: OneOrMore[str], gcm: str, product_type: str, rcm: str, experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_hydrology_variables_derived_projections.__download__(
            period=period, variable=variable, experiment=experiment, rcm=rcm, gcm=gcm, ensemble_member=ensemble_member, product_type=product_type, time_aggregation=time_aggregation, hydrological_model=hydrological_model, variable_type=variable_type
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, hydrological_model: OneOrMore[str], variable_type: str, ensemble_member: OneOrMore[str], gcm: str, product_type: str, rcm: str, experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, hydrological_model=hydrological_model, variable_type=variable_type, ensemble_member=ensemble_member, gcm=gcm, product_type=product_type, rcm=rcm, experiment=experiment, variable=variable, period=period)

class Collection_reanalysis_carra_model_levels(Collection):

    @Collection.wrapper
    def download(cls, domain: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], product_type: str, model_level: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_model_levels.__download__(
            day=day, time=time, variable=variable, year=year, model_level=model_level, product_type=product_type, data_format=data_format, leadtime_hour=leadtime_hour, month=month, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: str, month: OneOrMore[str], leadtime_hour: OneOrMore[str], product_type: str, model_level: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        domain_valid_values = ['east_domain', 'west_domain']
        assert domain in domain_valid_values
        ...
        return download_data(domain=domain, month=month, leadtime_hour=leadtime_hour, product_type=product_type, model_level=model_level, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_projections_cmip6_decadal_prototype(Collection):

    @Collection.wrapper
    def download(cls, model: str, temporal_resolution: str, month: OneOrMore[str], year: OneOrMore[str], variable: str, day: OneOrMore[str], base_year: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_projections_cmip6_decadal_prototype.__download__(
            day=day, base_year=base_year, variable=variable, year=year, area_group=area_group, month=month, temporal_resolution=temporal_resolution, model=model
        )
    
    @classmethod
    def __download__(cls, model: str, temporal_resolution: str, month: OneOrMore[str], year: OneOrMore[str], variable: str, day: OneOrMore[str], base_year: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(model=model, temporal_resolution=temporal_resolution, month=month, year=year, variable=variable, day=day, base_year=base_year, area_group=area_group)

class Collection_sis_ecv_cmip5_bias_corrected(Collection):

    @Collection.wrapper
    def download(cls, experiment: str, variable: str, model: str, period: OneOrMore[str]):
        return Collection_sis_ecv_cmip5_bias_corrected.__download__(
            period=period, model=model, variable=variable, experiment=experiment
        )
    
    @classmethod
    def __download__(cls, experiment: str, variable: str, model: str, period: OneOrMore[str]):
        ...
        return download_data(experiment=experiment, variable=variable, model=model, period=period)

class Collection_satellite_surface_radiation_budget(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, climate_data_record_type: str, month: OneOrMore[str], sensor_on_satellite: OneOrMore[str], origin: str, product_family: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_surface_radiation_budget.__download__(
            day=day, variable=variable, year=year, product_family=product_family, origin=origin, sensor_on_satellite=sensor_on_satellite, area_group=area_group, month=month, climate_data_record_type=climate_data_record_type, time_aggregation=time_aggregation
        )
...
class Collection_satellite_sea_ice_thickness(Collection):
    ...
    @Collection.wrapper
    def download(cls, cdr_type: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], year: OneOrMore[str], version: str = '3_0', variable: str = 'all'):
        return Collection_satellite_sea_ice_thickness.__download__(
            variable=variable, year=year, satellite=satellite, month=month, version=version, cdr_type=cdr_type
        )
    
    @classmethod
    def __download__(cls, cdr_type: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], year: OneOrMore[str], version: str = '3_0', variable: str = 'all'):
        cdr_type_valid_values = ['cdr', 'icdr']
        assert cdr_type in cdr_type_valid_values
        ...
        return download_data(cdr_type=cdr_type, month=month, satellite=satellite, year=year, version=version, variable=variable)

class Collection_sis_extreme_indices_cmip6(Collection):

    @Collection.wrapper
    def download(cls, model: OneOrMore[str], temporal_aggregation: OneOrMore[str], ensemble_member: OneOrMore[str], product_type: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str], version: OneOrMore[str] = '2_0'):
        return Collection_sis_extreme_indices_cmip6.__download__(
            period=period, variable=variable, experiment=experiment, product_type=product_type, ensemble_member=ensemble_member, temporal_aggregation=temporal_aggregation, version=version, model=model
        )
    
    @classmethod
    def __download__(cls, model: OneOrMore[str], temporal_aggregation: OneOrMore[str], ensemble_member: OneOrMore[str], product_type: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str], version: OneOrMore[str] = '2_0'):
        ...
        return download_data(model=model, temporal_aggregation=temporal_aggregation, ensemble_member=ensemble_member, product_type=product_type, experiment=experiment, variable=variable, period=period, version=version)

class Collection_satellite_aerosol_properties(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, version: OneOrMore[str], month: OneOrMore[str], sensor_on_satellite: str, algorithm: str, orbit: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str]):
        return Collection_satellite_aerosol_properties.__download__(
            day=day, variable=variable, year=year, orbit=orbit, algorithm=algorithm, sensor_on_satellite=sensor_on_satellite, month=month, version=version, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, version: OneOrMore[str], month: OneOrMore[str], sensor_on_satellite: str, algorithm: str, orbit: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, version=version, month=month, sensor_on_satellite=sensor_on_satellite, algorithm=algorithm, orbit=orbit, year=year, variable=variable, day=day)

class Collection_insitu_observations_igra_baseline_network(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], archive: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_igra_baseline_network.__download__(
            format=format, day=day, variable=variable, year=year, archive=archive, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], archive: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, archive=archive, year=year, variable=variable, day=day, format=format, area_group=area_group)

class Collection_satellite_ocean_colour(Collection):

    @Collection.wrapper
    def download(cls, version: str, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], projection: str):
        return Collection_satellite_ocean_colour.__download__(
            day=day, projection=projection, variable=variable, year=year, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, version: str, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], projection: str):
        ...
        return download_data(version=version, month=month, year=year, variable=variable, day=day, projection=projection)

class Collection_reanalysis_oras5(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], vertical_resolution: str, product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_reanalysis_oras5.__download__(
            variable=variable, year=year, product_type=product_type, vertical_resolution=vertical_resolution, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], vertical_resolution: str, product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, vertical_resolution=vertical_resolution, product_type=product_type, year=year, variable=variable)

class Collection_sis_european_wind_storm_indicators(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], month: OneOrMore[str], product: OneOrMore[str], spatial_aggregation: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        return Collection_sis_european_wind_storm_indicators.__download__(
            day=day, variable=variable, year=year, spatial_aggregation=spatial_aggregation, product=product, month=month, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], month: OneOrMore[str], product: OneOrMore[str], spatial_aggregation: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(time_aggregation=time_aggregation, month=month, product=product, spatial_aggregation=spatial_aggregation, year=year, day=day, variable=variable)

class Collection_satellite_earth_radiation_budget(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, version: OneOrMore[str], climate_data_record_type: str, month: OneOrMore[str], sensor_on_satellite: OneOrMore[str], origin: str, product_family: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_earth_radiation_budget.__download__(
            day=day, variable=variable, year=year, product_family=product_family, origin=origin, sensor_on_satellite=sensor_on_satellite, area_group=area_group, month=month, climate_data_record_type=climate_data_record_type, version=version, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, version: OneOrMore[str], climate_data_record_type: str, month: OneOrMore[str], sensor_on_satellite: OneOrMore[str], origin: str, product_family: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(time_aggregation=time_aggregation, version=version, climate_data_record_type=climate_data_record_type, month=month, sensor_on_satellite=sensor_on_satellite, origin=origin, product_family=product_family, year=year, variable=variable, day=day, area_group=area_group)

class Collection_sis_hydrology_variables_derived_seasonal_forecast(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], hydrological_model: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = 1):
        return Collection_sis_hydrology_variables_derived_seasonal_forecast.__download__(
            variable=variable, year=year, hydrological_model=hydrological_model, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], hydrological_model: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = 1):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, hydrological_model=hydrological_model, year=year, variable=variable, version=version)

class Collection_ecv_for_climate_change(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], month: OneOrMore[str], climate_reference_period: OneOrMore[str], origin: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_ecv_for_climate_change.__download__(
            variable=variable, year=year, product_type=product_type, climate_reference_period=climate_reference_period, origin=origin, month=month, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], month: OneOrMore[str], climate_reference_period: OneOrMore[str], origin: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, month=month, climate_reference_period=climate_reference_period, origin=origin, product_type=product_type, year=year, variable=variable)

class Collection_sis_energy_pecd(Collection):

    @Collection.wrapper
    def download(cls, temporal_period: OneOrMore[str], month: OneOrMore[str], technology: OneOrMore[str], origin: OneOrMore[str], emissions: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], spatial_resolution: OneOrMore[str], area_group: Union[GeographicExtentType, FreeEditionType] = 'global', area: Optional[str] = None, pecd_version: str = 'pecd4_1'):
        return Collection_sis_energy_pecd.__download__(
            spatial_resolution=spatial_resolution, variable=variable, year=year, pecd_version=pecd_version, area=area, emissions=emissions, origin=origin, technology=technology, area_group=area_group, month=month, temporal_period=temporal_period
        )
    
    @classmethod
    def __download__(cls, temporal_period: OneOrMore[str], month: OneOrMore[str], technology: OneOrMore[str], origin: OneOrMore[str], emissions: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], spatial_resolution: OneOrMore[str], area_group: Union[GeographicExtentType, FreeEditionType] = 'global', area: Optional[str] = None, pecd_version: str = 'pecd4_1'):
        ...
        return download_data(temporal_period=temporal_period, month=month, technology=technology, origin=origin, emissions=emissions, year=year, variable=variable, spatial_resolution=spatial_resolution, area_group=area_group, area=area, pecd_version=pecd_version)

class Collection_satellite_sea_ice_concentration(Collection):

    @Collection.wrapper
    def download(cls, cdr_type: OneOrMore[str], version: str, month: OneOrMore[str], sensor: str, origin: str, region: OneOrMore[str], temporal_aggregation: str, year: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_sea_ice_concentration.__download__(
            day=day, variable=variable, year=year, temporal_aggregation=temporal_aggregation, region=region, origin=origin, sensor=sensor, month=month, version=version, cdr_type=cdr_type
        )
    
    @classmethod
    def __download__(cls, cdr_type: OneOrMore[str], version: str, month: OneOrMore[str], sensor: str, origin: str, region: OneOrMore[str], temporal_aggregation: str, year: OneOrMore[str], day: OneOrMore[str], variable: str = 'all'):
        cdr_type_valid_values = ['cdr', 'icdr']
        assert cdr_type in cdr_type_valid_values
        ...
        return download_data(cdr_type=cdr_type, version=version, month=month, sensor=sensor, origin=origin, region=region, temporal_aggregation=temporal_aggregation, year=year, day=day, variable=variable)

class Collection_derived_utci_historical(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], product_type: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], version: str = '1_1', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_derived_utci_historical.__download__(
            day=day, variable=variable, year=year, product_type=product_type, area_group=area_group, month=month, version=version
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], product_type: str, year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str], version: str = '1_1', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, product_type=product_type, year=year, variable=variable, day=day, version=version, area_group=area_group)

class Collection_sis_water_level_change_timeseries_cmip6(Collection):

    @Collection.wrapper
    def download(cls, model: OneOrMore[str], month: OneOrMore[str], temporal_aggregation: OneOrMore[str], experiment: str, year: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_water_level_change_timeseries_cmip6.__download__(
            variable=variable, year=year, experiment=experiment, temporal_aggregation=temporal_aggregation, month=month, model=model
        )
    
    @classmethod
    def __download__(cls, model: OneOrMore[str], month: OneOrMore[str], temporal_aggregation: OneOrMore[str], experiment: str, year: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(model=model, month=month, temporal_aggregation=temporal_aggregation, experiment=experiment, year=year, variable=variable)

class Collection_satellite_lai_fapar(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], horizontal_resolution: OneOrMore[str], product_version: str, satellite: OneOrMore[str], sensor: str, nominal_day: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_lai_fapar.__download__(
            variable=variable, year=year, nominal_day=nominal_day, sensor=sensor, satellite=satellite, product_version=product_version, horizontal_resolution=horizontal_resolution, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], horizontal_resolution: OneOrMore[str], product_version: str, satellite: OneOrMore[str], sensor: str, nominal_day: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, horizontal_resolution=horizontal_resolution, product_version=product_version, satellite=satellite, sensor=sensor, nominal_day=nominal_day, year=year, variable=variable, area_group=area_group)

class Collection_satellite_land_cover(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], version: OneOrMore[str], variable: str = 'all', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_land_cover.__download__(
            variable=variable, area_group=area_group, version=version, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], version: OneOrMore[str], variable: str = 'all', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(year=year, version=version, variable=variable, area_group=area_group)
...
class Collection_satellite_total_column_water_vapour_ocean(Collection):
    ...
    def download(cls, climate_data_record_type: str, month: OneOrMore[str], origin: str, temporal_aggregation: str, year: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_total_column_water_vapour_ocean.__download__(
            variable=variable, year=year, temporal_aggregation=temporal_aggregation, origin=origin, month=month, climate_data_record_type=climate_data_record_type
        )
    
    @classmethod
    def __download__(cls, climate_data_record_type: str, month: OneOrMore[str], origin: str, temporal_aggregation: str, year: OneOrMore[str], variable: str = 'all'):
        climate_data_record_type_valid_values = ['icdr', 'tcdr']
        assert climate_data_record_type in climate_data_record_type_valid_values
        ...
        return download_data(climate_data_record_type=climate_data_record_type, month=month, origin=origin, temporal_aggregation=temporal_aggregation, year=year, variable=variable)

class Collection_projections_cmip5_monthly_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, model: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str], ensemble_member: str = 'r1i1p1'):
        return Collection_projections_cmip5_monthly_pressure_levels.__download__(
            period=period, variable=variable, experiment=experiment, ensemble_member=ensemble_member, model=model
        )
...
class Collection_sis_hydrology_meteorology_derived_projections(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], horizontal_resolution: str, variable_type: str, processing_type: str, ensemble_member: OneOrMore[str], gcm: str, product_type: str, rcm: str, experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_hydrology_meteorology_derived_projections.__download__(
            period=period, variable=variable, experiment=experiment, rcm=rcm, gcm=gcm, ensemble_member=ensemble_member, product_type=product_type, time_aggregation=time_aggregation, processing_type=processing_type, horizontal_resolution=horizontal_resolution, variable_type=variable_type
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], horizontal_resolution: str, variable_type: str, processing_type: str, ensemble_member: OneOrMore[str], gcm: str, product_type: str, rcm: str, experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        time_aggregation_valid_values = ['daily', 'monthly_mean', 'annual_mean']
        assert time_aggregation in time_aggregation_valid_values
        ...
        return download_data(time_aggregation=time_aggregation, horizontal_resolution=horizontal_resolution, variable_type=variable_type, processing_type=processing_type, ensemble_member=ensemble_member, gcm=gcm, product_type=product_type, rcm=rcm, experiment=experiment, variable=variable, period=period)

class Collection_sis_water_level_change_indicators_cmip6(Collection):

    @Collection.wrapper
    def download(cls, multi_model_ensemble_statistic: OneOrMore[str], model: OneOrMore[str], statistic: OneOrMore[str], confidence_interval: OneOrMore[str], derived_variable: OneOrMore[str], product_type: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_water_level_change_indicators_cmip6.__download__(
            period=period, variable=variable, experiment=experiment, product_type=product_type, derived_variable=derived_variable, confidence_interval=confidence_interval, model=model, multi_model_ensemble_statistic=multi_model_ensemble_statistic, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, multi_model_ensemble_statistic: OneOrMore[str], model: OneOrMore[str], statistic: OneOrMore[str], confidence_interval: OneOrMore[str], derived_variable: OneOrMore[str], product_type: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        ...
        return download_data(multi_model_ensemble_statistic=multi_model_ensemble_statistic, model=model, statistic=statistic, confidence_interval=confidence_interval, derived_variable=derived_variable, product_type=product_type, experiment=experiment, variable=variable, period=period)

class Collection_sis_agroclimatic_indicators(Collection):

    @Collection.wrapper
    def download(cls, version: OneOrMore[str], origin: str, temporal_aggregation: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_agroclimatic_indicators.__download__(
            period=period, variable=variable, experiment=experiment, temporal_aggregation=temporal_aggregation, origin=origin, version=version
        )
    
    @classmethod
    def __download__(cls, version: OneOrMore[str], origin: str, temporal_aggregation: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str]):
        version_valid_values = ['1_0', '1_1']
        assert version in version_valid_values
        ...
        return download_data(version=version, origin=origin, temporal_aggregation=temporal_aggregation, experiment=experiment, variable=variable, period=period)

class Collection_projections_climate_atlas(Collection):

    @Collection.wrapper
    def download(cls, domain: str, origin: str, experiment: str, variable: str, period: str):
        return Collection_projections_climate_atlas.__download__(
            period=period, variable=variable, experiment=experiment, origin=origin, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: str, origin: str, experiment: str, variable: str, period: str):
        ...
        return download_data(domain=domain, origin=origin, experiment=experiment, variable=variable, period=period)

class Collection_reanalysis_carra_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, domain: str, pressure_level: OneOrMore[str], month: OneOrMore[str], leadtime_hour: OneOrMore[str], product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_pressure_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, leadtime_hour=leadtime_hour, month=month, pressure_level=pressure_level, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: str, pressure_level: OneOrMore[str], month: OneOrMore[str], leadtime_hour: OneOrMore[str], product_type: str, year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], data_format: str = 'grib'):
        domain_valid_values = ['east_domain', 'west_domain']
        assert domain in domain_valid_values
        ...
        return download_data(domain=domain, pressure_level=pressure_level, month=month, leadtime_hour=leadtime_hour, product_type=product_type, year=year, variable=variable, time=time, day=day, data_format=data_format)

class Collection_sis_biodiversity_cmip5_global(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], model: OneOrMore[str], derived_variable: OneOrMore[str], temporal_aggregation: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_cmip5_global.__download__(
            variable=variable, experiment=experiment, ensemble_member=ensemble_member, temporal_aggregation=temporal_aggregation, derived_variable=derived_variable, version=version, model=model, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], model: OneOrMore[str], derived_variable: OneOrMore[str], temporal_aggregation: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        statistic_valid_values = ['mean', 'median', '25th_quartile', '75th_quartile']
        assert statistic in statistic_valid_values
        ...
        return download_data(statistic=statistic, model=model, derived_variable=derived_variable, temporal_aggregation=temporal_aggregation, ensemble_member=ensemble_member, experiment=experiment, variable=variable, version=version)

class Collection_insitu_gridded_observations_nordic(Collection):

    @Collection.wrapper
    def download(cls, spatial_interpolation_method: OneOrMore[str], version: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str]):
        return Collection_insitu_gridded_observations_nordic.__download__(
            day=day, variable=variable, year=year, product_type=product_type, month=month, version=version, spatial_interpolation_method=spatial_interpolation_method
        )
    
    @classmethod
    def __download__(cls, spatial_interpolation_method: OneOrMore[str], version: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], day: OneOrMore[str]):
        ...
        return download_data(spatial_interpolation_method=spatial_interpolation_method, version=version, month=month, product_type=product_type, year=year, variable=variable, day=day)

class Collection_reanalysis_era5_pressure_levels_monthly_means(Collection):

    @Collection.wrapper
    def download(cls, pressure_level: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib'):
        return Collection_reanalysis_era5_pressure_levels_monthly_means.__download__(
            time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, month=month, download_format=download_format, area_group=area_group, pressure_level=pressure_level
        )
    
    @classmethod
    def __download__(cls, pressure_level: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib'):
        pressure_level_valid_values = ['1', '2', '3', '5', '7', '10', '20', '30', '50', '70', '100', '125', '150', '175', '200', '225', '250', '300', '350', '400', '450', '500', '550', '600', '650', '700', '750', '775', '800', '825', '850', '875', '900', '925', '950', '975', '1000']
        assert pressure_level in pressure_level_valid_values
        ...
        return download_data(pressure_level=pressure_level, month=month, product_type=product_type, year=year, variable=variable, time=time, area_group=area_group, download_format=download_format, data_format=data_format)

class Collection_satellite_precipitation(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, month: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        return Collection_satellite_precipitation.__download__(
            day=day, variable=variable, year=year, area_group=area_group, month=month, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, month: OneOrMore[str], year: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        time_aggregation_valid_values = ['monthly_mean', 'daily_mean']
        assert time_aggregation in time_aggregation_valid_values
        ...
        return download_data(time_aggregation=time_aggregation, month=month, year=year, day=day, area_group=area_group, variable=variable)

class Collection_insitu_observations_gnss(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], network_type: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_gnss.__download__(
            format=format, day=day, variable=variable, year=year, area_group=area_group, network_type=network_type, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], network_type: OneOrMore[str], year: str, variable: OneOrMore[str], day: OneOrMore[str], format: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, network_type=network_type, year=year, variable=variable, day=day, format=format, area_group=area_group)

class Collection_sis_agrometeorological_indicators(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], version: str = '1_1', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_sis_agrometeorological_indicators.__download__(
            day=day, time=time, variable=variable, year=year, area_group=area_group, month=month, version=version, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], variable: str, time: OneOrMore[str], day: OneOrMore[str], version: str = '1_1', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(statistic=statistic, month=month, year=year, variable=variable, time=time, day=day, version=version, area_group=area_group)

class Collection_sis_tourism_fire_danger_indicators(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, gcm_model: OneOrMore[str], version: str, product_type: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_tourism_fire_danger_indicators.__download__(
            period=period, variable=variable, experiment=experiment, product_type=product_type, version=version, gcm_model=gcm_model, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, gcm_model: OneOrMore[str], version: str, product_type: str, experiment: str, variable: OneOrMore[str], period: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, gcm_model=gcm_model, version=version, product_type=product_type, experiment=experiment, variable=variable, period=period)

class Collection_sis_ecde_climate_indicators(Collection):

    @Collection.wrapper
    def download(cls, hydrological_model: OneOrMore[str], origin: str, spatial_aggregation: str, regional_layer: OneOrMore[str], temporal_aggregation: OneOrMore[str], ensemble_member: OneOrMore[str], gcm: OneOrMore[str], rcm: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], other_parameters: OneOrMore[str]):
        return Collection_sis_ecde_climate_indicators.__download__(
            other_parameters=other_parameters, variable=variable, experiment=experiment, rcm=rcm, gcm=gcm, regional_layer=regional_layer, temporal_aggregation=temporal_aggregation, ensemble_member=ensemble_member, spatial_aggregation=spatial_aggregation, origin=origin, hydrological_model=hydrological_model
        )
    
    @classmethod
    def __download__(cls, hydrological_model: OneOrMore[str], origin: str, spatial_aggregation: str, regional_layer: OneOrMore[str], temporal_aggregation: OneOrMore[str], ensemble_member: OneOrMore[str], gcm: OneOrMore[str], rcm: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], other_parameters: OneOrMore[str]):
        ...
        return download_data(hydrological_model=hydrological_model, origin=origin, spatial_aggregation=spatial_aggregation, regional_layer=regional_layer, temporal_aggregation=temporal_aggregation, ensemble_member=ensemble_member, gcm=gcm, rcm=rcm, experiment=experiment, variable=variable, other_parameters=other_parameters)

class Collection_satellite_humidity_profiles(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: str, variable: str = 'all'):
        return Collection_satellite_humidity_profiles.__download__(
            product_type=product_type, month=month, variable=variable, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: str, variable: str = 'all'):
        ...
        return download_data(year=year, month=month, product_type=product_type, variable=variable)

class Collection_reanalysis_era5_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], pressure_level: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis'):
        return Collection_reanalysis_era5_pressure_levels.__download__(
            day=day, time=time, variable=variable, year=year, product_type=product_type, data_format=data_format, pressure_level=pressure_level, download_format=download_format, area_group=area_group, month=month
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], pressure_level: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], time: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived', data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis'):
        month_valid_values = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
        assert month in month_valid_values
        ...
        return download_data(month=month, pressure_level=pressure_level, year=year, variable=variable, time=time, day=day, area_group=area_group, download_format=download_format, data_format=data_format, product_type=product_type)
