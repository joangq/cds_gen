...
class Collection_sis_energy_derived_projections(Collection):
    ...
    @Collection.wrapper
    def download(cls, spatial_aggregation: str, temporal_aggregation: str, rcm: str, ensemble_member: OneOrMore[str], gcm: OneOrMore[str], energy_product_type: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_energy_derived_projections.__download__(
            experiment=experiment, variable=variable, energy_product_type=energy_product_type, gcm=gcm, ensemble_member=ensemble_member, rcm=rcm, temporal_aggregation=temporal_aggregation, spatial_aggregation=spatial_aggregation
        )
    
    @classmethod
    def __download__(cls, spatial_aggregation: str, temporal_aggregation: str, rcm: str, ensemble_member: OneOrMore[str], gcm: OneOrMore[str], energy_product_type: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(spatial_aggregation=spatial_aggregation, temporal_aggregation=temporal_aggregation, rcm=rcm, ensemble_member=ensemble_member, gcm=gcm, energy_product_type=energy_product_type, experiment=experiment, variable=variable)
...
class Collection_satellite_lake_water_level(Collection):
    ...
    def download(cls, lake: OneOrMore[str], region: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_lake_water_level.__download__(
            region=region, variable=variable, lake=lake
        )
...
class Collection_satellite_lake_water_temperature(Collection):
    ...
    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_lake_water_temperature.__download__(
            variable=variable, version=version, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(year=year, month=month, day=day, version=version, variable=variable)

class Collection_multi_origin_c3s_atlas(Collection):

    @Collection.wrapper
    def download(cls, origin: str, period: str, domain: str, variable: str, experiment: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_multi_origin_c3s_atlas.__download__(
            variable=variable, experiment=experiment, domain=domain, area_group=area_group, period=period, origin=origin
        )
    
    @classmethod
    def __download__(cls, origin: str, period: str, domain: str, variable: str, experiment: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(origin=origin, period=period, domain=domain, variable=variable, experiment=experiment, area_group=area_group)

class Collection_seasonal_postprocessed_single_levels(Collection):

    @Collection.wrapper
    def download(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], product_type: OneOrMore[str], leadtime_month: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_seasonal_postprocessed_single_levels.__download__(
            variable=variable, leadtime_month=leadtime_month, area_group=area_group, product_type=product_type, month=month, originating_centre=originating_centre, year=year, system=system, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], product_type: OneOrMore[str], leadtime_month: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(system=system, year=year, originating_centre=originating_centre, month=month, product_type=product_type, leadtime_month=leadtime_month, variable=variable, data_format=data_format, area_group=area_group)
...
class Collection_satellite_soil_moisture(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], type_of_record: OneOrMore[str], type_of_sensor: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_satellite_soil_moisture.__download__(
            variable=variable, version=version, day=day, month=month, year=year, type_of_sensor=type_of_sensor, type_of_record=type_of_record, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], type_of_record: OneOrMore[str], type_of_sensor: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, type_of_record=type_of_record, type_of_sensor=type_of_sensor, year=year, month=month, day=day, version=version, variable=variable)

class Collection_insitu_gridded_observations_alpine_precipitation(Collection):

    @Collection.wrapper
    def download(cls, dataset_issue: OneOrMore[str], version: OneOrMore[str] = '1.2', variable: str = 'precipitation'):
        return Collection_insitu_gridded_observations_alpine_precipitation.__download__(
            variable=variable, version=version, dataset_issue=dataset_issue
        )
...
class Collection_reanalysis_cerra_model_levels(Collection):
    ...
    @Collection.wrapper
    def download(cls, data_type: OneOrMore[str], model_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_model_levels.__download__(
            variable=variable, time=time, day=day, month=month, year=year, model_level=model_level, data_format=data_format, data_type=data_type
        )
    
    @classmethod
    def __download__(cls, data_type: OneOrMore[str], model_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib'):
        ...
        return download_data(data_type=data_type, model_level=model_level, year=year, month=month, day=day, time=time, variable=variable, data_format=data_format)

class Collection_reanalysis_uerra_europe_single_levels(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, time: OneOrMore[str], variable: str, data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_single_levels.__download__(
            variable=variable, time=time, day=day, month=month, origin=origin, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, time: OneOrMore[str], variable: str, data_format: str = 'grib'):
        ...
        return download_data(year=year, day=day, month=month, origin=origin, time=time, variable=variable, data_format=data_format)

class Collection_insitu_observations_near_surface_temperature_us_climate_reference_network(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_near_surface_temperature_us_climate_reference_network.__download__(
            format=format, variable=variable, area_group=area_group, day=day, month=month, year=year, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(time_aggregation=time_aggregation, year=year, month=month, day=day, format=format, variable=variable, area_group=area_group)

class Collection_seasonal_original_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], day: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_seasonal_original_pressure_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, pressure_level=pressure_level, area_group=area_group, day=day, month=month, originating_centre=originating_centre, year=year, system=system, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], day: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        system_valid_values = ['1', '2', '3', '4', '5', '6', '7', '8', '12', '13', '14', '15', '21', '35', '51', '600', '601', '602', '603']
        assert system in system_valid_values
        ...
        return download_data(system=system, year=year, originating_centre=originating_centre, month=month, day=day, pressure_level=pressure_level, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format, area_group=area_group)

class Collection_satellite_albedo(Collection):

    @Collection.wrapper
    def download(cls, product_version: OneOrMore[str], nominal_day: OneOrMore[str], horizontal_resolution: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], sensor: str, variable: OneOrMore[str], area: Optional[str] = None, area_group: Optional[Union[GeographicExtentMapType, LabelType]] = None):
        return Collection_satellite_albedo.__download__(
            variable=variable, sensor=sensor, satellite=satellite, area_group=area_group, area=area, month=month, year=year, horizontal_resolution=horizontal_resolution, nominal_day=nominal_day, product_version=product_version
        )
    
    @classmethod
    def __download__(cls, product_version: OneOrMore[str], nominal_day: OneOrMore[str], horizontal_resolution: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], sensor: str, variable: OneOrMore[str], area: Optional[str] = None, area_group: Optional[Union[GeographicExtentMapType, LabelType]] = None):
        ...
        return download_data(product_version=product_version, nominal_day=nominal_day, horizontal_resolution=horizontal_resolution, year=year, month=month, satellite=satellite, sensor=sensor, variable=variable, area=area, area_group=area_group)

class Collection_satellite_upper_troposphere_humidity(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], sensor_on_satellite: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        return Collection_satellite_upper_troposphere_humidity.__download__(
            variable=variable, area_group=area_group, sensor_on_satellite=sensor_on_satellite, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], sensor_on_satellite: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        ...
        return download_data(year=year, month=month, day=day, sensor_on_satellite=sensor_on_satellite, area_group=area_group, variable=variable)

class Collection_projections_cordex_domains_single_levels(Collection):

    @Collection.wrapper
    def download(cls, gcm_model: str, rcm_model: str, horizontal_resolution: str, end_year: OneOrMore[str], temporal_resolution: str, start_year: OneOrMore[str], ensemble_member: str, domain: str, variable: OneOrMore[str], experiment: str):
        return Collection_projections_cordex_domains_single_levels.__download__(
            variable=variable, experiment=experiment, ensemble_member=ensemble_member, domain=domain, start_year=start_year, temporal_resolution=temporal_resolution, end_year=end_year, horizontal_resolution=horizontal_resolution, rcm_model=rcm_model, gcm_model=gcm_model
        )
    
    @classmethod
    def __download__(cls, gcm_model: str, rcm_model: str, horizontal_resolution: str, end_year: OneOrMore[str], temporal_resolution: str, start_year: OneOrMore[str], ensemble_member: str, domain: str, variable: OneOrMore[str], experiment: str):
        ...
        return download_data(gcm_model=gcm_model, rcm_model=rcm_model, horizontal_resolution=horizontal_resolution, end_year=end_year, temporal_resolution=temporal_resolution, start_year=start_year, ensemble_member=ensemble_member, domain=domain, variable=variable, experiment=experiment)
...
class Collection_sis_health_vector(Collection):
    ...
    def download(cls, ensemble_statistic: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_health_vector.__download__(
            experiment=experiment, variable=variable, ensemble_statistic=ensemble_statistic
        )
    
    @classmethod
    def __download__(cls, ensemble_statistic: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(ensemble_statistic=ensemble_statistic, experiment=experiment, variable=variable)

class Collection_reanalysis_cerra_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, data_type: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_pressure_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, pressure_level=pressure_level, time=time, product_type=product_type, day=day, month=month, year=year, data_format=data_format, data_type=data_type
        )
    
    @classmethod
    def __download__(cls, data_type: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        data_type_valid_values = ['ensemble_members', 'reanalysis']
        assert data_type in data_type_valid_values
        ...
        return download_data(data_type=data_type, year=year, month=month, day=day, product_type=product_type, time=time, pressure_level=pressure_level, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_sis_marine_properties(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, year: OneOrMore[str], month: OneOrMore[str], origin: str, vertical_resolution: str, experiment: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_marine_properties.__download__(
            experiment=experiment, variable=variable, vertical_resolution=vertical_resolution, origin=origin, month=month, year=year, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, year: OneOrMore[str], month: OneOrMore[str], origin: str, vertical_resolution: str, experiment: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, year=year, month=month, origin=origin, vertical_resolution=vertical_resolution, experiment=experiment, variable=variable)

class Collection_reanalysis_uerra_europe_soil_levels(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, soil_level: OneOrMore[str], time: OneOrMore[str], variable: str, data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_soil_levels.__download__(
            variable=variable, time=time, soil_level=soil_level, day=day, month=month, origin=origin, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, soil_level: OneOrMore[str], time: OneOrMore[str], variable: str, data_format: str = 'grib'):
        year_valid_values = ['1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019']
        assert year in year_valid_values
        ...
        return download_data(year=year, day=day, month=month, origin=origin, soil_level=soil_level, time=time, variable=variable, data_format=data_format)
...
class Collection_sis_biodiversity_era5_regional(Collection):
    ...
    def download(cls, statistic: OneOrMore[str], derived_variable: OneOrMore[str], origin: str, region: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_era5_regional.__download__(
            variable=variable, region=region, version=version, origin=origin, derived_variable=derived_variable, statistic=statistic
        )
...
class Collection_sis_hydrology_variables_derived_seasonal_reforecast(Collection):
    ...
    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], version: OneOrMore[str], hydrological_model: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_hydrology_variables_derived_seasonal_reforecast.__download__(
            hydrological_model=hydrological_model, variable=variable, version=version, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], version: OneOrMore[str], hydrological_model: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(year=year, month=month, version=version, hydrological_model=hydrological_model, variable=variable)

class Collection_reanalysis_era5_single_levels(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        return Collection_reanalysis_era5_single_levels.__download__(
            variable=variable, download_format=download_format, time=time, area_group=area_group, product_type=product_type, day=day, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        ...
        return download_data(year=year, month=month, day=day, time=time, variable=variable, data_format=data_format, product_type=product_type, area_group=area_group, download_format=download_format)

class Collection_sis_energy_derived_reanalysis(Collection):

    @Collection.wrapper
    def download(cls, spatial_aggregation: OneOrMore[str], temporal_aggregation: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], energy_product_type: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_energy_derived_reanalysis.__download__(
            variable=variable, energy_product_type=energy_product_type, year=year, month=month, temporal_aggregation=temporal_aggregation, spatial_aggregation=spatial_aggregation
        )
    
    @classmethod
    def __download__(cls, spatial_aggregation: OneOrMore[str], temporal_aggregation: OneOrMore[str], month: OneOrMore[str], year: OneOrMore[str], energy_product_type: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(spatial_aggregation=spatial_aggregation, temporal_aggregation=temporal_aggregation, month=month, year=year, energy_product_type=energy_product_type, variable=variable)

class Collection_satellite_sea_level_global(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], version: str = 'vDT2021'):
        return Collection_satellite_sea_level_global.__download__(
            variable=variable, version=version, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], version: str = 'vDT2021'):
        ...
        return download_data(year=year, month=month, day=day, variable=variable, version=version)

class Collection_satellite_sea_surface_temperature_ensemble_product(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], day: OneOrMore[str], year: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_sea_surface_temperature_ensemble_product.__download__(
            year=year, variable=variable, day=day, month=month
        )
...
class Collection_reanalysis_carra_height_levels(Collection):
    ...
    @Collection.wrapper
    def download(cls, height_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_height_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, domain=domain, time=time, product_type=product_type, day=day, month=month, year=year, data_format=data_format, height_level=height_level
        )
    
    @classmethod
    def __download__(cls, height_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        ...
        return download_data(height_level=height_level, year=year, month=month, day=day, product_type=product_type, time=time, domain=domain, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_derived_era5_land_daily_statistics(Collection):

    @Collection.wrapper
    def download(cls, year: str, month: str, day: OneOrMore[str], variable: OneOrMore[str], daily_statistic: str = 'daily_mean', time_zone: str = 'utc+00:00', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', frequency: str = '1_hourly'):
        return Collection_derived_era5_land_daily_statistics.__download__(
            variable=variable, frequency=frequency, area_group=area_group, time_zone=time_zone, day=day, month=month, daily_statistic=daily_statistic, year=year
        )
    
    @classmethod
    def __download__(cls, year: str, month: str, day: OneOrMore[str], variable: OneOrMore[str], daily_statistic: str = 'daily_mean', time_zone: str = 'utc+00:00', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', frequency: str = '1_hourly'):
        ...
        return download_data(year=year, month=month, day=day, variable=variable, daily_statistic=daily_statistic, time_zone=time_zone, area_group=area_group, frequency=frequency)

class Collection_insitu_observations_woudc_ozone_total_column_and_profiles(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], observation_type: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_woudc_ozone_total_column_and_profiles.__download__(
            format=format, variable=variable, area_group=area_group, observation_type=observation_type, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], observation_type: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(year=year, month=month, day=day, observation_type=observation_type, format=format, variable=variable, area_group=area_group)
...
class Collection_insitu_glaciers_extent(Collection):
    ...
    def download(cls, product_type: OneOrMore[str], variable: OneOrMore[str], version: str = '7'):
        return Collection_insitu_glaciers_extent.__download__(
            variable=variable, version=version, product_type=product_type
        )
...
class Collection_projections_cmip5_daily_pressure_levels(Collection):
    ...
    @Collection.wrapper
    def download(cls, model: str, period: OneOrMore[str], variable: OneOrMore[str], experiment: str, ensemble_member: str = 'r1i1p1'):
        return Collection_projections_cmip5_daily_pressure_levels.__download__(
            variable=variable, experiment=experiment, ensemble_member=ensemble_member, period=period, model=model
        )
    
    @classmethod
    def __download__(cls, model: str, period: OneOrMore[str], variable: OneOrMore[str], experiment: str, ensemble_member: str = 'r1i1p1'):
        ...
        return download_data(model=model, period=period, variable=variable, experiment=experiment, ensemble_member=ensemble_member)

class Collection_satellite_fire_burned_area(Collection):

    @Collection.wrapper
    def download(cls, nominal_day: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], origin: str, version: str, region: OneOrMore[str], sensor: str, variable: str):
        return Collection_satellite_fire_burned_area.__download__(
            variable=variable, sensor=sensor, region=region, version=version, origin=origin, month=month, year=year, nominal_day=nominal_day
        )
    
    @classmethod
    def __download__(cls, nominal_day: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], origin: str, version: str, region: OneOrMore[str], sensor: str, variable: str):
        ...
        return download_data(nominal_day=nominal_day, year=year, month=month, origin=origin, version=version, region=region, sensor=sensor, variable=variable)

class Collection_reanalysis_uerra_europe_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: str, data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_pressure_levels.__download__(
            variable=variable, pressure_level=pressure_level, time=time, day=day, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: str, data_format: str = 'grib'):
        year_valid_values = ['1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, time=time, pressure_level=pressure_level, variable=variable, data_format=data_format)

class Collection_satellite_sea_ice_edge_type(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], cdr_type: str, month: OneOrMore[str], day: OneOrMore[str], region: str, variable: OneOrMore[str], version: str = '3_0'):
        return Collection_satellite_sea_ice_edge_type.__download__(
            variable=variable, region=region, version=version, day=day, month=month, cdr_type=cdr_type, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], cdr_type: str, month: OneOrMore[str], day: OneOrMore[str], region: str, variable: OneOrMore[str], version: str = '3_0'):
        year_valid_values = ['1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, cdr_type=cdr_type, month=month, day=day, region=region, variable=variable, version=version)
...
class Collection_sis_ocean_wave_timeseries(Collection):
    ...
    def download(cls, experiment: str, variable: OneOrMore[str], year: OneOrMore[str]):
        return Collection_sis_ocean_wave_timeseries.__download__(
            year=year, experiment=experiment, variable=variable
        )
...
class Collection_satellite_cloud_properties(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: str, climate_data_record_type: str, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, sensor_on_satellite: OneOrMore[str], variable: OneOrMore[str], product_family: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_cloud_properties.__download__(
            variable=variable, product_family=product_family, area_group=area_group, sensor_on_satellite=sensor_on_satellite, day=day, month=month, origin=origin, year=year, climate_data_record_type=climate_data_record_type, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, climate_data_record_type: str, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, sensor_on_satellite: OneOrMore[str], variable: OneOrMore[str], product_family: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(time_aggregation=time_aggregation, climate_data_record_type=climate_data_record_type, year=year, day=day, month=month, origin=origin, sensor_on_satellite=sensor_on_satellite, variable=variable, product_family=product_family, area_group=area_group)

class Collection_seasonal_postprocessed_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], product_type: OneOrMore[str], leadtime_month: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_seasonal_postprocessed_pressure_levels.__download__(
            variable=variable, pressure_level=pressure_level, leadtime_month=leadtime_month, area_group=area_group, product_type=product_type, month=month, originating_centre=originating_centre, year=year, system=system, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], product_type: OneOrMore[str], leadtime_month: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        system_valid_values = ['1', '2', '3', '4', '5', '6', '7', '8', '12', '13', '14', '15', '21', '35', '51', '600', '601', '602', '603']
        assert system in system_valid_values
        ...
        return download_data(system=system, year=year, originating_centre=originating_centre, month=month, product_type=product_type, leadtime_month=leadtime_month, pressure_level=pressure_level, variable=variable, data_format=data_format, area_group=area_group)

class Collection_sis_heat_and_cold_spells(Collection):

    @Collection.wrapper
    def download(cls, ensemble_statistic: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], definition: str):
        return Collection_sis_heat_and_cold_spells.__download__(
            definition=definition, experiment=experiment, variable=variable, ensemble_statistic=ensemble_statistic
        )
    
    @classmethod
    def __download__(cls, ensemble_statistic: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], definition: str):
        ensemble_statistic_valid_values = ['ensemble_members_average', 'ensemble_members_standard_deviation']
        assert ensemble_statistic in ensemble_statistic_valid_values
        ...
        return download_data(ensemble_statistic=ensemble_statistic, experiment=experiment, variable=variable, definition=definition)
...
class Collection_derived_gridded_glacier_mass_change(Collection):
    ...
    def download(cls, hydrological_year: OneOrMore[str], product_version: str = 'wgms_fog_2023_09', variable: str = 'glacier_mass_change'):
        return Collection_derived_gridded_glacier_mass_change.__download__(
            variable=variable, hydrological_year=hydrological_year, product_version=product_version
        )
...
class Collection_reanalysis_cerra_land(Collection):
    ...
    @Collection.wrapper
    def download(cls, year: OneOrMore[str], soil_layer: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], level_type: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_land.__download__(
            leadtime_hour=leadtime_hour, variable=variable, time=time, product_type=product_type, level_type=level_type, day=day, month=month, soil_layer=soil_layer, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], soil_layer: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], level_type: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        year_valid_values = ['1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021']
        assert year in year_valid_values
        ...
        return download_data(year=year, soil_layer=soil_layer, month=month, day=day, level_type=level_type, product_type=product_type, time=time, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_satellite_sea_surface_temperature(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], sensor_on_satellite: str, processinglevel: str, version: str = '2_1', variable: str = 'all'):
        return Collection_satellite_sea_surface_temperature.__download__(
            variable=variable, processinglevel=processinglevel, version=version, sensor_on_satellite=sensor_on_satellite, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], sensor_on_satellite: str, processinglevel: str, version: str = '2_1', variable: str = 'all'):
        ...
        return download_data(year=year, month=month, day=day, sensor_on_satellite=sensor_on_satellite, processinglevel=processinglevel, version=version, variable=variable)

class Collection_reanalysis_uerra_europe_height_levels(Collection):

    @Collection.wrapper
    def download(cls, height_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: str, data_format: str = 'grib'):
        return Collection_reanalysis_uerra_europe_height_levels.__download__(
            variable=variable, time=time, day=day, month=month, year=year, data_format=data_format, height_level=height_level
        )
    
    @classmethod
    def __download__(cls, height_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: str, data_format: str = 'grib'):
        height_level_valid_values = ['15_m', '30_m', '50_m', '75_m', '100_m', '150_m', '200_m', '250_m', '300_m', '400_m', '500_m']
        assert height_level in height_level_valid_values
        ...
        return download_data(height_level=height_level, year=year, month=month, day=day, time=time, variable=variable, data_format=data_format)

class Collection_reanalysis_era5_land(Collection):

    @Collection.wrapper
    def download(cls, year: str, month: str, day: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        return Collection_reanalysis_era5_land.__download__(
            variable=variable, download_format=download_format, time=time, area_group=area_group, day=day, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: str, month: str, day: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        year_valid_values = ['1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, time=time, variable=variable, data_format=data_format, area_group=area_group, download_format=download_format)

class Collection_reanalysis_carra_single_levels(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], level_type: str, soil_level: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_single_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, domain=domain, time=time, product_type=product_type, soil_level=soil_level, level_type=level_type, day=day, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], level_type: str, soil_level: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        year_valid_values = ['1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, level_type=level_type, soil_level=soil_level, product_type=product_type, time=time, domain=domain, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_sis_biodiversity_cmip5_regional(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], derived_variable: OneOrMore[str], model: OneOrMore[str], region: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_cmip5_regional.__download__(
            experiment=experiment, variable=variable, ensemble_member=ensemble_member, region=region, version=version, model=model, derived_variable=derived_variable, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], derived_variable: OneOrMore[str], model: OneOrMore[str], region: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        statistic_valid_values = ['mean', 'median', '25th_quartile', '75th_quartile']
        assert statistic in statistic_valid_values
        ...
        return download_data(statistic=statistic, derived_variable=derived_variable, model=model, region=region, ensemble_member=ensemble_member, experiment=experiment, variable=variable, version=version)

class Collection_insitu_gridded_observations_global_and_regional(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, statistic: OneOrMore[str], horizontal_aggregation: OneOrMore[str], origin: str, year: OneOrMore[str], version: OneOrMore[str], region: str, variable: OneOrMore[str]):
        return Collection_insitu_gridded_observations_global_and_regional.__download__(
            variable=variable, region=region, version=version, year=year, origin=origin, horizontal_aggregation=horizontal_aggregation, statistic=statistic, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, statistic: OneOrMore[str], horizontal_aggregation: OneOrMore[str], origin: str, year: OneOrMore[str], version: OneOrMore[str], region: str, variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, statistic=statistic, horizontal_aggregation=horizontal_aggregation, origin=origin, year=year, version=version, region=region, variable=variable)
...
class Collection_sis_biodiversity_era5_global(Collection):
    ...
    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], temporal_aggregation: OneOrMore[str], derived_variable: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_era5_global.__download__(
            variable=variable, version=version, derived_variable=derived_variable, temporal_aggregation=temporal_aggregation, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], temporal_aggregation: OneOrMore[str], derived_variable: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        statistic_valid_values = ['mean', 'median', '25th_quartile', '75th_quartile']
        assert statistic in statistic_valid_values
        ...
        return download_data(statistic=statistic, temporal_aggregation=temporal_aggregation, derived_variable=derived_variable, variable=variable, version=version)

class Collection_reanalysis_era5_land_monthly_means(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        return Collection_reanalysis_era5_land_monthly_means.__download__(
            variable=variable, download_format=download_format, time=time, area_group=area_group, product_type=product_type, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        year_valid_values = ['1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, product_type=product_type, time=time, variable=variable, data_format=data_format, area_group=area_group, download_format=download_format)

class Collection_insitu_comprehensive_upper_air_observation_network(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_comprehensive_upper_air_observation_network.__download__(
            format=format, variable=variable, area_group=area_group, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(year=year, month=month, day=day, format=format, variable=variable, area_group=area_group)

class Collection_projections_cmip6(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], temporal_resolution: str, day: OneOrMore[str], month: OneOrMore[str], model: str, level: OneOrMore[str], variable: str, experiment: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_projections_cmip6.__download__(
            variable=variable, experiment=experiment, area_group=area_group, level=level, model=model, day=day, month=month, temporal_resolution=temporal_resolution, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], temporal_resolution: str, day: OneOrMore[str], month: OneOrMore[str], model: str, level: OneOrMore[str], variable: str, experiment: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(year=year, temporal_resolution=temporal_resolution, day=day, month=month, model=model, level=level, variable=variable, experiment=experiment, area_group=area_group)

class Collection_insitu_observations_gruan_reference_network(Collection):

    @Collection.wrapper
    def download(cls, year: str, month: str, day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_gruan_reference_network.__download__(
            format=format, variable=variable, area_group=area_group, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: str, month: str, day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
...
class Collection_insitu_gridded_observations_europe(Collection):
    ...
    @Collection.wrapper
    def download(cls, period: str, grid_resolution: str, product_type: str, version: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_insitu_gridded_observations_europe.__download__(
            variable=variable, version=version, product_type=product_type, grid_resolution=grid_resolution, period=period
        )
    
    @classmethod
    def __download__(cls, period: str, grid_resolution: str, product_type: str, version: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(period=period, grid_resolution=grid_resolution, product_type=product_type, version=version, variable=variable)

class Collection_derived_era5_pressure_levels_daily_statistics(Collection):

    @Collection.wrapper
    def download(cls, year: str, month: OneOrMore[str], day: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', time_zone: str = 'utc+00:00', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', frequency: str = '1_hourly'):
        return Collection_derived_era5_pressure_levels_daily_statistics.__download__(
            variable=variable, pressure_level=pressure_level, frequency=frequency, area_group=area_group, time_zone=time_zone, product_type=product_type, day=day, month=month, daily_statistic=daily_statistic, year=year
        )
    
    @classmethod
    def __download__(cls, year: str, month: OneOrMore[str], day: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', time_zone: str = 'utc+00:00', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', frequency: str = '1_hourly'):
        year_valid_values = ['1940', '1941', '1942', '1943', '1944', '1945', '1946', '1947', '1948', '1949', '1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, pressure_level=pressure_level, variable=variable, daily_statistic=daily_statistic, product_type=product_type, time_zone=time_zone, area_group=area_group, frequency=frequency)
...
class Collection_derived_near_surface_meteorological_variables(Collection):
    ...
    @Collection.wrapper
    def download(cls, reference_dataset: str, year: OneOrMore[str], month: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '2.1'):
        return Collection_derived_near_surface_meteorological_variables.__download__(
            variable=variable, version=version, month=month, year=year, reference_dataset=reference_dataset
        )
...
class Collection_sis_tourism_snow_indicators(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: str, statistic: OneOrMore[str], year: OneOrMore[str], period: OneOrMore[str], rcm: str, version: OneOrMore[str], gcm: OneOrMore[str], experiment: str, variable: OneOrMore[str]):
        return Collection_sis_tourism_snow_indicators.__download__(
            experiment=experiment, variable=variable, gcm=gcm, version=version, rcm=rcm, period=period, year=year, statistic=statistic, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, statistic: OneOrMore[str], year: OneOrMore[str], period: OneOrMore[str], rcm: str, version: OneOrMore[str], gcm: OneOrMore[str], experiment: str, variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, statistic=statistic, year=year, period=period, rcm=rcm, version=version, gcm=gcm, experiment=experiment, variable=variable)
...
class Collection_sis_european_risk_extreme_precipitation_indicators(Collection):
    ...
    @Collection.wrapper
    def download(cls, spatial_coverage: OneOrMore[str], temporal_aggregation: OneOrMore[str], period: OneOrMore[str], product_type: OneOrMore[str], city: OneOrMore[str], percentile: OneOrMore[str], return_period: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_european_risk_extreme_precipitation_indicators.__download__(
            return_period=return_period, variable=variable, percentile=percentile, city=city, product_type=product_type, period=period, temporal_aggregation=temporal_aggregation, spatial_coverage=spatial_coverage
        )
    
    @classmethod
    def __download__(cls, spatial_coverage: OneOrMore[str], temporal_aggregation: OneOrMore[str], period: OneOrMore[str], product_type: OneOrMore[str], city: OneOrMore[str], percentile: OneOrMore[str], return_period: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(spatial_coverage=spatial_coverage, temporal_aggregation=temporal_aggregation, period=period, product_type=product_type, city=city, percentile=percentile, return_period=return_period, variable=variable)

class Collection_satellite_total_column_water_vapour_land_ocean(Collection):

    @Collection.wrapper
    def download(cls, horizontal_aggregation: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], year: OneOrMore[str], temporal_aggregation: str, product: str, variable: str = 'all'):
        return Collection_satellite_total_column_water_vapour_land_ocean.__download__(
            variable=variable, temporal_aggregation=temporal_aggregation, product=product, year=year, day=day, month=month, horizontal_aggregation=horizontal_aggregation
        )
    
    @classmethod
    def __download__(cls, horizontal_aggregation: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], year: OneOrMore[str], temporal_aggregation: str, product: str, variable: str = 'all'):
        ...
        return download_data(horizontal_aggregation=horizontal_aggregation, month=month, day=day, year=year, temporal_aggregation=temporal_aggregation, product=product, variable=variable)

class Collection_sis_temperature_statistics(Collection):

    @Collection.wrapper
    def download(cls, ensemble_statistic: OneOrMore[str], statistic: OneOrMore[str], period: str, experiment: OneOrMore[str], variable: str):
        return Collection_sis_temperature_statistics.__download__(
            experiment=experiment, variable=variable, period=period, statistic=statistic, ensemble_statistic=ensemble_statistic
        )
    
    @classmethod
    def __download__(cls, ensemble_statistic: OneOrMore[str], statistic: OneOrMore[str], period: str, experiment: OneOrMore[str], variable: str):
        ensemble_statistic_valid_values = ['ensemble_members_average', 'ensemble_members_standard_deviation']
        assert ensemble_statistic in ensemble_statistic_valid_values
        ...
        return download_data(ensemble_statistic=ensemble_statistic, statistic=statistic, period=period, experiment=experiment, variable=variable)

class Collection_satellite_fire_radiative_power(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, horizontal_aggregation: str, month: OneOrMore[str], day: OneOrMore[str], year: str, product_type: str, version: OneOrMore[str], satellite: OneOrMore[str], observation_time: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_fire_radiative_power.__download__(
            observation_time=observation_time, variable=variable, satellite=satellite, version=version, product_type=product_type, year=year, day=day, month=month, horizontal_aggregation=horizontal_aggregation, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, horizontal_aggregation: str, month: OneOrMore[str], day: OneOrMore[str], year: str, product_type: str, version: OneOrMore[str], satellite: OneOrMore[str], observation_time: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(time_aggregation=time_aggregation, horizontal_aggregation=horizontal_aggregation, month=month, day=day, year=year, product_type=product_type, version=version, satellite=satellite, observation_time=observation_time, variable=variable)

class Collection_satellite_methane(Collection):

    @Collection.wrapper
    def download(cls, sensor_and_algorithm: str, processing_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str], variable: str):
        return Collection_satellite_methane.__download__(
            variable=variable, version=version, day=day, month=month, year=year, processing_level=processing_level, sensor_and_algorithm=sensor_and_algorithm
        )
    
    @classmethod
    def __download__(cls, sensor_and_algorithm: str, processing_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str], variable: str):
        ...
        return download_data(sensor_and_algorithm=sensor_and_algorithm, processing_level=processing_level, year=year, month=month, day=day, version=version, variable=variable)

class Collection_satellite_ice_sheet_elevation_change(Collection):

    @Collection.wrapper
    def download(cls, domain: OneOrMore[str], climate_data_record_type: OneOrMore[str], version: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_ice_sheet_elevation_change.__download__(
            variable=variable, version=version, climate_data_record_type=climate_data_record_type, domain=domain
        )
    
    @classmethod
    def __download__(cls, domain: OneOrMore[str], climate_data_record_type: OneOrMore[str], version: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(domain=domain, climate_data_record_type=climate_data_record_type, version=version, variable=variable)
...
class Collection_insitu_observations_surface_land(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: str, usage_restrictions: OneOrMore[str], month: OneOrMore[str], data_quality: OneOrMore[str], day: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_surface_land.__download__(
            variable=variable, area_group=area_group, year=year, day=day, data_quality=data_quality, month=month, usage_restrictions=usage_restrictions, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, usage_restrictions: OneOrMore[str], month: OneOrMore[str], data_quality: OneOrMore[str], day: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(time_aggregation=time_aggregation, usage_restrictions=usage_restrictions, month=month, data_quality=data_quality, day=day, year=year, variable=variable, area_group=area_group)
...
class Collection_insitu_observations_surface_marine(Collection):
    ...
    @Collection.wrapper
    def download(cls, year: OneOrMore[str], data_quality: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_surface_marine.__download__(
            variable=variable, area_group=area_group, day=day, month=month, data_quality=data_quality, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], data_quality: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(year=year, data_quality=data_quality, month=month, day=day, variable=variable, area_group=area_group)

class Collection_seasonal_monthly_ocean(Collection):

    @Collection.wrapper
    def download(cls, forecast_type: OneOrMore[str], system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_seasonal_monthly_ocean.__download__(
            variable=variable, month=month, originating_centre=originating_centre, year=year, system=system, forecast_type=forecast_type
        )
    
    @classmethod
    def __download__(cls, forecast_type: OneOrMore[str], system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(forecast_type=forecast_type, system=system, year=year, originating_centre=originating_centre, month=month, variable=variable)
...
class Collection_satellite_greenland_ice_sheet_velocity(Collection):
    ...
    def download(cls, version: OneOrMore[str], period: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_greenland_ice_sheet_velocity.__download__(
            period=period, variable=variable, version=version
        )
...
class Collection_satellite_ozone_v1(Collection):
    ...
    @Collection.wrapper
    def download(cls, vertical_aggregation: str, processing_level: str, year: OneOrMore[str], month: OneOrMore[str], version: OneOrMore[str], sensor: OneOrMore[str], algorithm: str, variable: str):
        return Collection_satellite_ozone_v1.__download__(
            variable=variable, algorithm=algorithm, sensor=sensor, version=version, month=month, year=year, processing_level=processing_level, vertical_aggregation=vertical_aggregation
        )
    
    @classmethod
    def __download__(cls, vertical_aggregation: str, processing_level: str, year: OneOrMore[str], month: OneOrMore[str], version: OneOrMore[str], sensor: OneOrMore[str], algorithm: str, variable: str):
        ...
        return download_data(vertical_aggregation=vertical_aggregation, processing_level=processing_level, year=year, month=month, version=version, sensor=sensor, algorithm=algorithm, variable=variable)

class Collection_derived_era5_single_levels_daily_statistics(Collection):

    @Collection.wrapper
    def download(cls, year: str, month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', time_zone: str = 'utc+00:00', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', frequency: str = '1_hourly'):
        return Collection_derived_era5_single_levels_daily_statistics.__download__(
            variable=variable, frequency=frequency, area_group=area_group, time_zone=time_zone, product_type=product_type, day=day, month=month, daily_statistic=daily_statistic, year=year
        )
    
    @classmethod
    def __download__(cls, year: str, month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], daily_statistic: str = 'daily_mean', product_type: str = 'reanalysis', time_zone: str = 'utc+00:00', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', frequency: str = '1_hourly'):
        year_valid_values = ['1940', '1941', '1942', '1943', '1944', '1945', '1946', '1947', '1948', '1949', '1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, variable=variable, daily_statistic=daily_statistic, product_type=product_type, time_zone=time_zone, area_group=area_group, frequency=frequency)

class Collection_seasonal_original_single_levels(Collection):

    @Collection.wrapper
    def download(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_seasonal_original_single_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, area_group=area_group, day=day, month=month, originating_centre=originating_centre, year=year, system=system, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, system: str, year: OneOrMore[str], originating_centre: str, month: OneOrMore[str], day: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        system_valid_values = ['1', '2', '3', '4', '5', '6', '7', '8', '12', '13', '14', '15', '21', '35', '51', '600', '601', '602', '603']
        assert system in system_valid_values
        ...
        return download_data(system=system, year=year, originating_centre=originating_centre, month=month, day=day, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format, area_group=area_group)

class Collection_reanalysis_cerra_single_levels(Collection):

    @Collection.wrapper
    def download(cls, data_type: OneOrMore[str], year: OneOrMore[str], soil_layer: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], level_type: str, product_type: str, time: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_single_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, time=time, product_type=product_type, level_type=level_type, day=day, month=month, soil_layer=soil_layer, year=year, data_format=data_format, data_type=data_type
        )
    
    @classmethod
    def __download__(cls, data_type: OneOrMore[str], year: OneOrMore[str], soil_layer: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], level_type: str, product_type: str, time: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        data_type_valid_values = ['ensemble_members', 'reanalysis']
        assert data_type in data_type_valid_values
        ...
        return download_data(data_type=data_type, year=year, soil_layer=soil_layer, month=month, day=day, level_type=level_type, product_type=product_type, time=time, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_satellite_precipitation_microwave(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str] = 'v1.0', variable: str = 'all'):
        return Collection_satellite_precipitation_microwave.__download__(
            variable=variable, version=version, day=day, month=month, year=year, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], version: OneOrMore[str] = 'v1.0', variable: str = 'all'):
        time_aggregation_valid_values = ['daily', 'monthly']
        assert time_aggregation in time_aggregation_valid_values
        ...
        return download_data(time_aggregation=time_aggregation, year=year, month=month, day=day, version=version, variable=variable)

class Collection_sis_ocean_wave_indicators(Collection):

    @Collection.wrapper
    def download(cls, experiment: str, statistic: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        return Collection_sis_ocean_wave_indicators.__download__(
            period=period, experiment=experiment, variable=variable, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, experiment: str, statistic: OneOrMore[str], variable: OneOrMore[str], period: OneOrMore[str]):
        ...
        return download_data(experiment=experiment, statistic=statistic, variable=variable, period=period)

class Collection_sis_european_wind_storm_synthetic_events(Collection):

    @Collection.wrapper
    def download(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], version_id: OneOrMore[str]):
        return Collection_sis_european_wind_storm_synthetic_events.__download__(
            year=year, variable=variable, month=month, version_id=version_id
        )
    
    @classmethod
    def __download__(cls, month: OneOrMore[str], year: OneOrMore[str], variable: OneOrMore[str], version_id: OneOrMore[str]):
        ...
        return download_data(month=month, year=year, variable=variable, version_id=version_id)
...
class Collection_reanalysis_cerra_height_levels(Collection):
    ...
    @Collection.wrapper
    def download(cls, data_type: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: OneOrMore[str], height_level: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_cerra_height_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, time=time, height_level=height_level, product_type=product_type, day=day, month=month, year=year, data_format=data_format, data_type=data_type
        )
    
    @classmethod
    def __download__(cls, data_type: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: OneOrMore[str], height_level: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        data_type_valid_values = ['ensemble_members', 'reanalysis']
        assert data_type in data_type_valid_values
        ...
        return download_data(data_type=data_type, year=year, month=month, day=day, product_type=product_type, height_level=height_level, time=time, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_sis_agroproductivity_indicators(Collection):

    @Collection.wrapper
    def download(cls, harvest_year: str, year: str, month: OneOrMore[str], day: OneOrMore[str], crop_type: OneOrMore[str], growing_season: OneOrMore[str], variable: OneOrMore[str], product_family: OneOrMore[str]):
        return Collection_sis_agroproductivity_indicators.__download__(
            variable=variable, product_family=product_family, growing_season=growing_season, crop_type=crop_type, day=day, month=month, year=year, harvest_year=harvest_year
        )
    
    @classmethod
    def __download__(cls, harvest_year: str, year: str, month: OneOrMore[str], day: OneOrMore[str], crop_type: OneOrMore[str], growing_season: OneOrMore[str], variable: OneOrMore[str], product_family: OneOrMore[str]):
        ...
        return download_data(harvest_year=harvest_year, year=year, month=month, day=day, crop_type=crop_type, growing_season=growing_season, variable=variable, product_family=product_family)
...
class Collection_derived_reanalysis_energy_moisture_budget(Collection):
    ...
    def download(cls, month: OneOrMore[str], variable: str, year: OneOrMore[str], area_group: Optional[Union[LabelType, GeographicExtentMapType]] = None):
        return Collection_derived_reanalysis_energy_moisture_budget.__download__(
            year=year, variable=variable, area_group=area_group, month=month
        )
...
class Collection_sis_hydrology_variables_derived_projections(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: str, period: OneOrMore[str], product_type: str, rcm: str, variable_type: str, ensemble_member: OneOrMore[str], gcm: str, hydrological_model: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_hydrology_variables_derived_projections.__download__(
            hydrological_model=hydrological_model, experiment=experiment, variable=variable, gcm=gcm, ensemble_member=ensemble_member, variable_type=variable_type, rcm=rcm, product_type=product_type, period=period, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, period: OneOrMore[str], product_type: str, rcm: str, variable_type: str, ensemble_member: OneOrMore[str], gcm: str, hydrological_model: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, period=period, product_type=product_type, rcm=rcm, variable_type=variable_type, ensemble_member=ensemble_member, gcm=gcm, hydrological_model=hydrological_model, experiment=experiment, variable=variable)

class Collection_reanalysis_carra_model_levels(Collection):

    @Collection.wrapper
    def download(cls, model_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_model_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, domain=domain, time=time, product_type=product_type, day=day, month=month, year=year, model_level=model_level, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, model_level: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        ...
        return download_data(model_level=model_level, year=year, month=month, day=day, product_type=product_type, time=time, domain=domain, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_projections_cmip6_decadal_prototype(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], temporal_resolution: str, day: OneOrMore[str], month: OneOrMore[str], model: str, base_year: str, variable: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_projections_cmip6_decadal_prototype.__download__(
            variable=variable, area_group=area_group, base_year=base_year, model=model, day=day, month=month, temporal_resolution=temporal_resolution, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], temporal_resolution: str, day: OneOrMore[str], month: OneOrMore[str], model: str, base_year: str, variable: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(year=year, temporal_resolution=temporal_resolution, day=day, month=month, model=model, base_year=base_year, variable=variable, area_group=area_group)

class Collection_sis_ecv_cmip5_bias_corrected(Collection):

    @Collection.wrapper
    def download(cls, experiment: str, model: str, variable: str, period: OneOrMore[str]):
        return Collection_sis_ecv_cmip5_bias_corrected.__download__(
            period=period, experiment=experiment, variable=variable, model=model
        )
    
    @classmethod
    def __download__(cls, experiment: str, model: str, variable: str, period: OneOrMore[str]):
        ...
        return download_data(experiment=experiment, model=model, variable=variable, period=period)
...
class Collection_satellite_sea_ice_thickness(Collection):
    ...
    @Collection.wrapper
    def download(cls, year: OneOrMore[str], cdr_type: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], version: str = '3_0', variable: str = 'all'):
        return Collection_satellite_sea_ice_thickness.__download__(
            variable=variable, satellite=satellite, version=version, month=month, cdr_type=cdr_type, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], cdr_type: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], version: str = '3_0', variable: str = 'all'):
        ...
        return download_data(year=year, cdr_type=cdr_type, month=month, satellite=satellite, version=version, variable=variable)

class Collection_sis_extreme_indices_cmip6(Collection):

    @Collection.wrapper
    def download(cls, temporal_aggregation: OneOrMore[str], model: OneOrMore[str], period: OneOrMore[str], product_type: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '2_0'):
        return Collection_sis_extreme_indices_cmip6.__download__(
            experiment=experiment, variable=variable, ensemble_member=ensemble_member, version=version, product_type=product_type, period=period, model=model, temporal_aggregation=temporal_aggregation
        )
    
    @classmethod
    def __download__(cls, temporal_aggregation: OneOrMore[str], model: OneOrMore[str], period: OneOrMore[str], product_type: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '2_0'):
        ...
        return download_data(temporal_aggregation=temporal_aggregation, model=model, period=period, product_type=product_type, ensemble_member=ensemble_member, experiment=experiment, variable=variable, version=version)

class Collection_satellite_aerosol_properties(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, year: OneOrMore[str], orbit: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], sensor_on_satellite: str, version: OneOrMore[str], algorithm: str, variable: OneOrMore[str]):
        return Collection_satellite_aerosol_properties.__download__(
            variable=variable, algorithm=algorithm, version=version, sensor_on_satellite=sensor_on_satellite, day=day, month=month, orbit=orbit, year=year, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, year: OneOrMore[str], orbit: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], sensor_on_satellite: str, version: OneOrMore[str], algorithm: str, variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, year=year, orbit=orbit, month=month, day=day, sensor_on_satellite=sensor_on_satellite, version=version, algorithm=algorithm, variable=variable)

class Collection_insitu_observations_igra_baseline_network(Collection):

    @Collection.wrapper
    def download(cls, archive: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_igra_baseline_network.__download__(
            format=format, variable=variable, area_group=area_group, day=day, month=month, year=year, archive=archive
        )
    
    @classmethod
    def __download__(cls, archive: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(archive=archive, year=year, month=month, day=day, format=format, variable=variable, area_group=area_group)

class Collection_satellite_ocean_colour(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], projection: str, month: OneOrMore[str], day: OneOrMore[str], version: str, variable: OneOrMore[str]):
        return Collection_satellite_ocean_colour.__download__(
            variable=variable, version=version, day=day, month=month, projection=projection, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], projection: str, month: OneOrMore[str], day: OneOrMore[str], version: str, variable: OneOrMore[str]):
        ...
        return download_data(year=year, projection=projection, month=month, day=day, version=version, variable=variable)

class Collection_reanalysis_oras5(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], vertical_resolution: str, variable: OneOrMore[str]):
        return Collection_reanalysis_oras5.__download__(
            variable=variable, vertical_resolution=vertical_resolution, product_type=product_type, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], vertical_resolution: str, variable: OneOrMore[str]):
        ...
        return download_data(year=year, month=month, product_type=product_type, vertical_resolution=vertical_resolution, variable=variable)

class Collection_sis_european_wind_storm_indicators(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], spatial_aggregation: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product: OneOrMore[str], variable: str = 'all'):
        return Collection_sis_european_wind_storm_indicators.__download__(
            variable=variable, product=product, day=day, month=month, year=year, spatial_aggregation=spatial_aggregation, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], spatial_aggregation: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(time_aggregation=time_aggregation, spatial_aggregation=spatial_aggregation, year=year, month=month, day=day, product=product, variable=variable)

class Collection_satellite_earth_radiation_budget(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, climate_data_record_type: str, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, sensor_on_satellite: OneOrMore[str], version: OneOrMore[str], variable: OneOrMore[str], product_family: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_earth_radiation_budget.__download__(
            variable=variable, product_family=product_family, version=version, area_group=area_group, sensor_on_satellite=sensor_on_satellite, day=day, month=month, origin=origin, year=year, climate_data_record_type=climate_data_record_type, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, climate_data_record_type: str, year: OneOrMore[str], day: OneOrMore[str], month: OneOrMore[str], origin: str, sensor_on_satellite: OneOrMore[str], version: OneOrMore[str], variable: OneOrMore[str], product_family: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(time_aggregation=time_aggregation, climate_data_record_type=climate_data_record_type, year=year, day=day, month=month, origin=origin, sensor_on_satellite=sensor_on_satellite, version=version, variable=variable, product_family=product_family, area_group=area_group)

class Collection_sis_hydrology_variables_derived_seasonal_forecast(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], hydrological_model: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = 1):
        return Collection_sis_hydrology_variables_derived_seasonal_forecast.__download__(
            hydrological_model=hydrological_model, variable=variable, version=version, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], hydrological_model: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = 1):
        year_valid_values = ['2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, hydrological_model=hydrological_model, variable=variable, version=version)

class Collection_ecv_for_climate_change(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], origin: OneOrMore[str], climate_reference_period: OneOrMore[str], product_type: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_ecv_for_climate_change.__download__(
            variable=variable, product_type=product_type, climate_reference_period=climate_reference_period, origin=origin, month=month, year=year, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], origin: OneOrMore[str], climate_reference_period: OneOrMore[str], product_type: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, year=year, month=month, origin=origin, climate_reference_period=climate_reference_period, product_type=product_type, variable=variable)

class Collection_sis_energy_pecd(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], origin: OneOrMore[str], temporal_period: OneOrMore[str], spatial_resolution: OneOrMore[str], emissions: OneOrMore[str], technology: OneOrMore[str], variable: OneOrMore[str], pecd_version: str = 'pecd4_1', area: Optional[str] = None, area_group: Union[GeographicExtentType, FreeEditionType] = 'global'):
        return Collection_sis_energy_pecd.__download__(
            technology=technology, variable=variable, emissions=emissions, area_group=area_group, spatial_resolution=spatial_resolution, area=area, temporal_period=temporal_period, origin=origin, month=month, year=year, pecd_version=pecd_version
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], origin: OneOrMore[str], temporal_period: OneOrMore[str], spatial_resolution: OneOrMore[str], emissions: OneOrMore[str], technology: OneOrMore[str], variable: OneOrMore[str], pecd_version: str = 'pecd4_1', area: Optional[str] = None, area_group: Union[GeographicExtentType, FreeEditionType] = 'global'):
        ...
        return download_data(year=year, month=month, origin=origin, temporal_period=temporal_period, spatial_resolution=spatial_resolution, emissions=emissions, technology=technology, variable=variable, pecd_version=pecd_version, area=area, area_group=area_group)

class Collection_satellite_sea_ice_concentration(Collection):

    @Collection.wrapper
    def download(cls, temporal_aggregation: str, day: OneOrMore[str], month: OneOrMore[str], cdr_type: OneOrMore[str], origin: str, year: OneOrMore[str], version: str, region: OneOrMore[str], sensor: str, variable: str = 'all'):
        return Collection_satellite_sea_ice_concentration.__download__(
            variable=variable, sensor=sensor, region=region, version=version, year=year, day=day, cdr_type=cdr_type, month=month, origin=origin, temporal_aggregation=temporal_aggregation
        )
    
    @classmethod
    def __download__(cls, temporal_aggregation: str, day: OneOrMore[str], month: OneOrMore[str], cdr_type: OneOrMore[str], origin: str, year: OneOrMore[str], version: str, region: OneOrMore[str], sensor: str, variable: str = 'all'):
        ...
        return download_data(temporal_aggregation=temporal_aggregation, day=day, month=month, cdr_type=cdr_type, origin=origin, year=year, version=version, region=region, sensor=sensor, variable=variable)

class Collection_derived_utci_historical(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', version: str = '1_1'):
        return Collection_derived_utci_historical.__download__(
            variable=variable, area_group=area_group, version=version, product_type=product_type, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', version: str = '1_1'):
        year_valid_values = ['1940', '1941', '1942', '1943', '1944', '1945', '1946', '1947', '1948', '1949', '1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, product_type=product_type, variable=variable, area_group=area_group, version=version)

class Collection_sis_water_level_change_timeseries_cmip6(Collection):

    @Collection.wrapper
    def download(cls, temporal_aggregation: OneOrMore[str], month: OneOrMore[str], model: OneOrMore[str], year: OneOrMore[str], experiment: str, variable: OneOrMore[str]):
        return Collection_sis_water_level_change_timeseries_cmip6.__download__(
            experiment=experiment, variable=variable, year=year, model=model, month=month, temporal_aggregation=temporal_aggregation
        )
    
    @classmethod
    def __download__(cls, temporal_aggregation: OneOrMore[str], month: OneOrMore[str], model: OneOrMore[str], year: OneOrMore[str], experiment: str, variable: OneOrMore[str]):
        ...
        return download_data(temporal_aggregation=temporal_aggregation, month=month, model=model, year=year, experiment=experiment, variable=variable)

class Collection_satellite_lai_fapar(Collection):

    @Collection.wrapper
    def download(cls, product_version: str, nominal_day: OneOrMore[str], horizontal_resolution: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], sensor: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_satellite_lai_fapar.__download__(
            variable=variable, sensor=sensor, satellite=satellite, area_group=area_group, month=month, year=year, horizontal_resolution=horizontal_resolution, nominal_day=nominal_day, product_version=product_version
        )
    
    @classmethod
    def __download__(cls, product_version: str, nominal_day: OneOrMore[str], horizontal_resolution: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], satellite: OneOrMore[str], sensor: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(product_version=product_version, nominal_day=nominal_day, horizontal_resolution=horizontal_resolution, year=year, month=month, satellite=satellite, sensor=sensor, variable=variable, area_group=area_group)
...
class Collection_satellite_land_cover(Collection):
    ...
    def download(cls, version: OneOrMore[str], year: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        return Collection_satellite_land_cover.__download__(
            year=year, variable=variable, version=version, area_group=area_group
        )
...
class Collection_satellite_total_column_water_vapour_ocean(Collection):
    ...
    @Collection.wrapper
    def download(cls, climate_data_record_type: str, temporal_aggregation: str, month: OneOrMore[str], origin: str, year: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_total_column_water_vapour_ocean.__download__(
            variable=variable, year=year, origin=origin, month=month, temporal_aggregation=temporal_aggregation, climate_data_record_type=climate_data_record_type
        )
    
    @classmethod
    def __download__(cls, climate_data_record_type: str, temporal_aggregation: str, month: OneOrMore[str], origin: str, year: OneOrMore[str], variable: str = 'all'):
        climate_data_record_type_valid_values = ['icdr', 'tcdr']
        assert climate_data_record_type in climate_data_record_type_valid_values
        ...
        return download_data(climate_data_record_type=climate_data_record_type, temporal_aggregation=temporal_aggregation, month=month, origin=origin, year=year, variable=variable)
...
class Collection_sis_hydrology_meteorology_derived_projections(Collection):
    ...
    @Collection.wrapper
    def download(cls, time_aggregation: OneOrMore[str], horizontal_resolution: str, period: OneOrMore[str], processing_type: str, product_type: str, rcm: str, variable_type: str, ensemble_member: OneOrMore[str], gcm: str, experiment: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_hydrology_meteorology_derived_projections.__download__(
            experiment=experiment, variable=variable, gcm=gcm, ensemble_member=ensemble_member, variable_type=variable_type, rcm=rcm, product_type=product_type, processing_type=processing_type, period=period, horizontal_resolution=horizontal_resolution, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: OneOrMore[str], horizontal_resolution: str, period: OneOrMore[str], processing_type: str, product_type: str, rcm: str, variable_type: str, ensemble_member: OneOrMore[str], gcm: str, experiment: OneOrMore[str], variable: OneOrMore[str]):
        time_aggregation_valid_values = ['daily', 'monthly_mean', 'annual_mean']
        assert time_aggregation in time_aggregation_valid_values
        ...
        return download_data(time_aggregation=time_aggregation, horizontal_resolution=horizontal_resolution, period=period, processing_type=processing_type, product_type=product_type, rcm=rcm, variable_type=variable_type, ensemble_member=ensemble_member, gcm=gcm, experiment=experiment, variable=variable)

class Collection_sis_water_level_change_indicators_cmip6(Collection):

    @Collection.wrapper
    def download(cls, multi_model_ensemble_statistic: OneOrMore[str], derived_variable: OneOrMore[str], statistic: OneOrMore[str], model: OneOrMore[str], period: OneOrMore[str], product_type: OneOrMore[str], experiment: OneOrMore[str], confidence_interval: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_water_level_change_indicators_cmip6.__download__(
            experiment=experiment, confidence_interval=confidence_interval, multi_model_ensemble_statistic=multi_model_ensemble_statistic, variable=variable, product_type=product_type, period=period, model=model, derived_variable=derived_variable, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, multi_model_ensemble_statistic: OneOrMore[str], derived_variable: OneOrMore[str], statistic: OneOrMore[str], model: OneOrMore[str], period: OneOrMore[str], product_type: OneOrMore[str], experiment: OneOrMore[str], confidence_interval: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(multi_model_ensemble_statistic=multi_model_ensemble_statistic, derived_variable=derived_variable, statistic=statistic, model=model, period=period, product_type=product_type, experiment=experiment, confidence_interval=confidence_interval, variable=variable)

class Collection_sis_agroclimatic_indicators(Collection):

    @Collection.wrapper
    def download(cls, temporal_aggregation: str, origin: str, period: OneOrMore[str], version: OneOrMore[str], experiment: str, variable: OneOrMore[str]):
        return Collection_sis_agroclimatic_indicators.__download__(
            experiment=experiment, variable=variable, version=version, period=period, origin=origin, temporal_aggregation=temporal_aggregation
        )
    
    @classmethod
    def __download__(cls, temporal_aggregation: str, origin: str, period: OneOrMore[str], version: OneOrMore[str], experiment: str, variable: OneOrMore[str]):
        ...
        return download_data(temporal_aggregation=temporal_aggregation, origin=origin, period=period, version=version, experiment=experiment, variable=variable)

class Collection_projections_climate_atlas(Collection):

    @Collection.wrapper
    def download(cls, origin: str, period: str, domain: str, variable: str, experiment: str):
        return Collection_projections_climate_atlas.__download__(
            variable=variable, experiment=experiment, domain=domain, period=period, origin=origin
        )
    
    @classmethod
    def __download__(cls, origin: str, period: str, domain: str, variable: str, experiment: str):
        ...
        return download_data(origin=origin, period=period, domain=domain, variable=variable, experiment=experiment)

class Collection_reanalysis_carra_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, pressure_level: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        return Collection_reanalysis_carra_pressure_levels.__download__(
            leadtime_hour=leadtime_hour, variable=variable, pressure_level=pressure_level, domain=domain, time=time, product_type=product_type, day=day, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: str, time: OneOrMore[str], domain: str, pressure_level: OneOrMore[str], variable: OneOrMore[str], leadtime_hour: OneOrMore[str], data_format: str = 'grib'):
        year_valid_values = ['1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, product_type=product_type, time=time, domain=domain, pressure_level=pressure_level, variable=variable, leadtime_hour=leadtime_hour, data_format=data_format)

class Collection_sis_biodiversity_cmip5_global(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], temporal_aggregation: OneOrMore[str], derived_variable: OneOrMore[str], model: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        return Collection_sis_biodiversity_cmip5_global.__download__(
            experiment=experiment, variable=variable, ensemble_member=ensemble_member, version=version, model=model, derived_variable=derived_variable, temporal_aggregation=temporal_aggregation, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], temporal_aggregation: OneOrMore[str], derived_variable: OneOrMore[str], model: OneOrMore[str], ensemble_member: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str], version: OneOrMore[str] = '1.0'):
        statistic_valid_values = ['mean', 'median', '25th_quartile', '75th_quartile']
        assert statistic in statistic_valid_values
        ...
        return download_data(statistic=statistic, temporal_aggregation=temporal_aggregation, derived_variable=derived_variable, model=model, ensemble_member=ensemble_member, experiment=experiment, variable=variable, version=version)

class Collection_insitu_gridded_observations_nordic(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: OneOrMore[str], version: OneOrMore[str], spatial_interpolation_method: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_insitu_gridded_observations_nordic.__download__(
            variable=variable, spatial_interpolation_method=spatial_interpolation_method, version=version, product_type=product_type, day=day, month=month, year=year
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], product_type: OneOrMore[str], version: OneOrMore[str], spatial_interpolation_method: OneOrMore[str], variable: OneOrMore[str]):
        year_valid_values = ['1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, product_type=product_type, version=version, spatial_interpolation_method=spatial_interpolation_method, variable=variable)

class Collection_reanalysis_era5_pressure_levels_monthly_means(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        return Collection_reanalysis_era5_pressure_levels_monthly_means.__download__(
            variable=variable, pressure_level=pressure_level, download_format=download_format, time=time, area_group=area_group, product_type=product_type, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        year_valid_values = ['1940', '1941', '1942', '1943', '1944', '1945', '1946', '1947', '1948', '1949', '1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, product_type=product_type, time=time, pressure_level=pressure_level, variable=variable, data_format=data_format, area_group=area_group, download_format=download_format)

class Collection_satellite_precipitation(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        return Collection_satellite_precipitation.__download__(
            variable=variable, area_group=area_group, day=day, month=month, year=year, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', variable: str = 'all'):
        time_aggregation_valid_values = ['monthly_mean', 'daily_mean']
        assert time_aggregation in time_aggregation_valid_values
        ...
        return download_data(time_aggregation=time_aggregation, year=year, month=month, day=day, area_group=area_group, variable=variable)

class Collection_insitu_observations_gnss(Collection):

    @Collection.wrapper
    def download(cls, year: str, network_type: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        return Collection_insitu_observations_gnss.__download__(
            format=format, variable=variable, area_group=area_group, day=day, month=month, network_type=network_type, year=year
        )
    
    @classmethod
    def __download__(cls, year: str, network_type: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], format: str, variable: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
        ...
        return download_data(year=year, network_type=network_type, month=month, day=day, format=format, variable=variable, area_group=area_group)

class Collection_sis_agrometeorological_indicators(Collection):

    @Collection.wrapper
    def download(cls, statistic: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global', version: str = '1_1'):
        return Collection_sis_agrometeorological_indicators.__download__(
            variable=variable, time=time, area_group=area_group, version=version, day=day, month=month, year=year, statistic=statistic
        )
    
    @classmethod
    def __download__(cls, statistic: OneOrMore[str], year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], variable: str, area_group: Union[FreeEditionType, GeographicExtentType] = 'global', version: str = '1_1'):
        ...
        return download_data(statistic=statistic, year=year, month=month, day=day, time=time, variable=variable, area_group=area_group, version=version)

class Collection_sis_tourism_fire_danger_indicators(Collection):

    @Collection.wrapper
    def download(cls, time_aggregation: str, gcm_model: OneOrMore[str], period: OneOrMore[str], product_type: str, version: str, experiment: str, variable: OneOrMore[str]):
        return Collection_sis_tourism_fire_danger_indicators.__download__(
            experiment=experiment, variable=variable, version=version, product_type=product_type, period=period, gcm_model=gcm_model, time_aggregation=time_aggregation
        )
    
    @classmethod
    def __download__(cls, time_aggregation: str, gcm_model: OneOrMore[str], period: OneOrMore[str], product_type: str, version: str, experiment: str, variable: OneOrMore[str]):
        ...
        return download_data(time_aggregation=time_aggregation, gcm_model=gcm_model, period=period, product_type=product_type, version=version, experiment=experiment, variable=variable)

class Collection_sis_ecde_climate_indicators(Collection):

    @Collection.wrapper
    def download(cls, spatial_aggregation: str, temporal_aggregation: OneOrMore[str], other_parameters: OneOrMore[str], origin: str, rcm: OneOrMore[str], regional_layer: OneOrMore[str], ensemble_member: OneOrMore[str], gcm: OneOrMore[str], hydrological_model: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        return Collection_sis_ecde_climate_indicators.__download__(
            hydrological_model=hydrological_model, experiment=experiment, variable=variable, gcm=gcm, ensemble_member=ensemble_member, regional_layer=regional_layer, rcm=rcm, origin=origin, other_parameters=other_parameters, temporal_aggregation=temporal_aggregation, spatial_aggregation=spatial_aggregation
        )
    
    @classmethod
    def __download__(cls, spatial_aggregation: str, temporal_aggregation: OneOrMore[str], other_parameters: OneOrMore[str], origin: str, rcm: OneOrMore[str], regional_layer: OneOrMore[str], ensemble_member: OneOrMore[str], gcm: OneOrMore[str], hydrological_model: OneOrMore[str], experiment: OneOrMore[str], variable: OneOrMore[str]):
        ...
        return download_data(spatial_aggregation=spatial_aggregation, temporal_aggregation=temporal_aggregation, other_parameters=other_parameters, origin=origin, rcm=rcm, regional_layer=regional_layer, ensemble_member=ensemble_member, gcm=gcm, hydrological_model=hydrological_model, experiment=experiment, variable=variable)

class Collection_satellite_humidity_profiles(Collection):

    @Collection.wrapper
    def download(cls, product_type: str, month: OneOrMore[str], year: OneOrMore[str], variable: str = 'all'):
        return Collection_satellite_humidity_profiles.__download__(
            year=year, variable=variable, month=month, product_type=product_type
        )
    
    @classmethod
    def __download__(cls, product_type: str, month: OneOrMore[str], year: OneOrMore[str], variable: str = 'all'):
        ...
        return download_data(product_type=product_type, month=month, year=year, variable=variable)

class Collection_reanalysis_era5_pressure_levels(Collection):

    @Collection.wrapper
    def download(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        return Collection_reanalysis_era5_pressure_levels.__download__(
            variable=variable, pressure_level=pressure_level, download_format=download_format, time=time, area_group=area_group, product_type=product_type, day=day, month=month, year=year, data_format=data_format
        )
    
    @classmethod
    def __download__(cls, year: OneOrMore[str], month: OneOrMore[str], day: OneOrMore[str], time: OneOrMore[str], pressure_level: OneOrMore[str], variable: OneOrMore[str], data_format: str = 'grib', product_type: OneOrMore[str] = 'reanalysis', area_group: Union[FreeEditionType, GeographicExtentType] = 'global', download_format: str = 'unarchived'):
        year_valid_values = ['1940', '1941', '1942', '1943', '1944', '1945', '1946', '1947', '1948', '1949', '1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024']
        assert year in year_valid_values
        ...
        return download_data(year=year, month=month, day=day, time=time, pressure_level=pressure_level, variable=variable, data_format=data_format, product_type=product_type, area_group=area_group, download_format=download_format)
