...
class Collection_seasonal_original_single_levels(Collection):
    collection_name = 'seasonal-original-single-levels'
    valid_values = dict(
    ...
    @Collection.wrapper
    def download(cls, day: OneOrMore[str], leadtime_hour: OneOrMore[str], month: OneOrMore[str], originating_centre: str, system: str, variable: OneOrMore[str], year: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'): 
        """
        Parameters
        ----------
        :param day:
...
def download_seasonal_original_single_levels(day: OneOrMore[str], leadtime_hour: OneOrMore[str], month: OneOrMore[str], originating_centre: str, system: str, variable: OneOrMore[str], year: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib'):
    return Collection_seasonal_original_single_levels.download(day=day, leadtime_hour=leadtime_hour, month=month, originating_centre=originating_centre, system=system, variable=variable, year=year, area_group=area_group, data_format=data_format)
