...
class Collection_satellite_cloud_properties(Collection):
    ...
    valid_values = dict(
        ...
        variable = ['cloud_fraction', 'cloud_top_level', 'cloud_physical_properties_of_the_ice_phase', 'cloud_physical_properties_of_the_liquid_phase', 'all_variables'],
...
def download_satellite_cloud_properties(climate_data_record_type: str, day: OneOrMore[str], month: OneOrMore[str], origin: str, product_family: str, sensor_on_satellite: OneOrMore[str], time_aggregation: str, variable: OneOrMore[str], year: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global'):
    return Collection_satellite_cloud_properties.download(climate_data_record_type=climate_data_record_type, day=day, month=month, origin=origin, product_family=product_family, sensor_on_satellite=sensor_on_satellite, time_aggregation=time_aggregation, variable=variable, year=year, area_group=area_group)
