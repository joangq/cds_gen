...
def download_projections_cmip5_monthly_pressure_levels(experiment: str, model: str, period: OneOrMore[str], variable: OneOrMore[str], ensemble_member: str = 'r1i1p1'):
    return Collection_projections_cmip5_monthly_pressure_levels.download(experiment=experiment, model=model, period=period, variable=variable, ensemble_member=ensemble_member)
