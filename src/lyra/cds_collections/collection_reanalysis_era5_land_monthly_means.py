...
class Collection_reanalysis_era5_land_monthly_means(Collection):
    collection_name = 'reanalysis-era5-land-monthly-means'
    valid_values = dict(
        month = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'],
        product_type = ['monthly_averaged_reanalysis', 'monthly_averaged_reanalysis_by_hour_of_day'],
    ...
    @Collection.wrapper
    def download(cls, month: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], year: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib', download_format: str = 'unarchived'): 
        """
        Parameters
        ----------
        :param month:
...
def download_reanalysis_era5_land_monthly_means(month: OneOrMore[str], product_type: OneOrMore[str], time: OneOrMore[str], variable: OneOrMore[str], year: OneOrMore[str], area_group: Union[FreeEditionType, GeographicExtentType] = 'global', data_format: str = 'grib', download_format: str = 'unarchived'):
    return Collection_reanalysis_era5_land_monthly_means.download(month=month, product_type=product_type, time=time, variable=variable, year=year, area_group=area_group, data_format=data_format, download_format=download_format)
